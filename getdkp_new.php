 ...
 *
 * $Id: getdkp.php 1154 2008-01-03 22:17:10Z osr-corgan $
 ******************************/
...
############# ######################################
	...
	$plugin_results = "SELECT plugin_installed FROM ".$table_prefix."plugins WHERE plugin_name = 'RaidPlan'";
	...
	{	
		...
		$raidplaneroutput .= TAB.TAB.TAB.TAB.TAB. '["raid_date"] = '.$row['raid_date'].','."\n";
		...
		$raidplaneroutput .= TAB.TAB.TAB.TAB.TAB. '["raid_note"] = "'.strto_wowutf($row['raid_note']).'",'."\n";
		...
		while ($row3 = mysql_fetch_array($eqdkp_members_results))
		{
			...
			{	
				...
				if (($row4 = mysql_fetch_array($raidplaner_user_result)))
				{
					...
					$raidplaneroutput .= TAB.TAB.TAB.TAB.TAB.TAB.TAB. '["subscribed"] = 4 ,'."\n";
			...
			else 
			{
				...
				$raidplaneroutput .= TAB.TAB.TAB.TAB.TAB.TAB.TAB. '["subscribed"] = '.$row2['attendees_subscribed'].','."\n";
				$raidplaneroutput .= TAB.TAB.TAB.TAB.TAB.TAB.TAB. '["note"] = "'.strto_wowutf($row2['attendees_note']).'",'."\n";
				$raidplaneroutput .= TAB.TAB.TAB.TAB.TAB.TAB. '},'."\r\n";
