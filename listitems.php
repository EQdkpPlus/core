...
elseif ( $_GET[URI_PAGE] == 'history' )
{
    ...
    $sql = 'SELECT i.item_id, i.item_name, i.item_buyer, i.item_date, i.raid_id, i.item_value, i.game_itemid, r.raid_name
            FROM ' . ITEMS_TABLE . ' i, ' . RAIDS_TABLE . ' r
...
while ( $item = $db->fetch_record($items_result) )
{
    ...
    $tpl->assign_block_vars('items_row', array(
        ...
        'BUYER' => ( !empty($item['item_buyer']) ) ? get_classNameImgViewmembers($item['item_buyer']) : '&lt;<i>Not Found</i>&gt;',
