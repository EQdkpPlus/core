     ...
     $raid_menu = array(  
      ...
      'gmultidkp' => array(
        ...
        '07features'  => array(
           99 => 'coins.png',
            0 => '0.7 Features',
            1 => array('link' => 'admin/manage_cache.php'.$SID, 'text' => $user->lang['pdc_manager'], 'check' => 'a_config_man'),
            2 => array('link' => 'admin/manage_alts.php'.$SID, 'text' => $user->lang['alt_manager'], 'check' => 'a_members_man'),
        ),
        'mysql' => array(
           99 => 'coins.png',
            0 => $user->lang['mysql'],
