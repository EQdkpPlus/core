...
if ( !defined('IN_ADMIN') )
{
    ...
    */
    ...
    if($in->get('rssajax')){
      ...
      if(($conf_plus['pk_rssfeed_lefttime']+($rsscachetime*3600)) < time()){
      ...
      if(($conf_plus['pk_rssfeed_righttime']+($rsscachetime*3600)) < time()){
      ...
      if(($conf_plus['pk_rssfeed_twittertime']+($rsscachetime*3600)) < time()){
