...
if ( !defined('IN_ADMIN') )
{
    ...
    */
    ...
    if($pcache->safe_mode){
      if($pcache->CheckWrite()){
        $tpl->assign_vars(array(
            ...
            'CHMOD_IMG'          => '<img src="../images/false.png">',
    ...
    if ($in->get('cache')=='reset') {
    	...
    	{
    		$pdc->del_suffix();	
    		System_Message('Reset done!','Plus Data Cache');
    	}
    }
    ...
    // Update Check
    include($eqdkp_root_path.'pluskernel/include/update.class.php');
    $myUpdate   = new UpdateCheck(
          				EQDKPPLUS_VCHECKURL,
          				$eqdkpplus_vcontrol,
		...
		$tpl->assign_vars(array(
      'SHOW_UPDATE_AVAILABLE'   => $myUpdate->UpdateAvailable(),
      'L_UPDATE_AVAILABLE_HEAD' => $user->lang['upd_available_head'],
      'L_UPDATE_AVAILABLE_IMG'  => '<img src="../images/updates.png">',
      'L_UPDATE_AVAILABLE_TXT'  => $user->lang['upd_available_txt'].'<br><br> <a href="javascript:Updates()">'.$user->lang['upd_available_link'].'</a>',
    ));
    // End of update Check
    ...
    $tpl->assign_vars(array(
        ...
        'PLUG_UPDATE_CHECK'   => $plugCheckDB->OutputHTML(),
     ...
     $raid_menu = array(  
      ...
      'gmultidkp' => array(
           99 => 'wand.png',
            ...
            3 => array('link' => 'pluskernel/portalmanager.php',         'text' => $user->lang['portalmanager'],  'check' => 'a_config_man'),
            4 => array('link' => 'admin/' . 'addmulti.php' . $SID,   'text' => $user->lang['Multi_addkonto'],  'check' => 'a_config_man'),
            5 => array('link' => 'admin/' .'listmulti.php' . $SID, 'text' => $user->lang['Multi_viewkonten'], 'check' => 'a_config_man'),
            6 => array('link' => 'admin/' .'index.php?cache=reset' , 'text' => 'Reset Cache', 'check' => 'a_config_man')
