    ...
    if(isset($_GET['update']))
    {
      ...
      switch ($update_type)
      {
        case "item_id"									: $sql_count = $this->update_database($update_type.'.sql'); 		break;
				...
				case "luna_wotlk"						: $sql_count = $this->update_database($update_type.'.sql'); 		break;
				...
				case "m9wotlk"							: $sql_count = $this->update_database($update_type.'.sql'); 		break;
				...
				case "classcolors"          			: $sql_count = $this->update_database($update_type.'.sql'); 		break;
				case "modelviewer"          			: $sql_count = $this->update_database($update_type.'.sql'); 		break;
				case "portal"							: $sql_count = $this->update_database($update_type.'.sql'); 		break;
				case "616"								: $sql_count = $this->update_database($update_type.'.sql'); 		break;
				case "620"								: $sql_count = $this->update_database($update_type.'.sql'); 		break;
				case "621"								: $sql_count = $this->update_database($update_type.'.sql'); 		break;
				case "622"								: $sql_count = $this->update_database($update_type.'.sql'); 		break;
			}
