...
class Manage_Members extends page_generic {
	...
	public function __construct(){
		...
		$handler = array(
			'mdel' => array('process' => 'member_del'),
			'mstatus' => array('process' => 'member_status'),
			'rankc' => array('process' => 'member_ranks'),
		);
	...
	public function display($messages=false){
		...
		$onclose_url = "if(event.originalEvent == undefined) { window.location.href = 'admin/manage_members.php'; } else { window.location.href = 'manage_members.php'; }";
		...
		$this->jquery->Dialog('AddChar', $this->user->lang('uc_add_char'), array('url'=>'../addcharacter.php?adminmode=1', 'width'=>'640', 'height'=>'520', 'onclosejs'=>$onclose_url));
