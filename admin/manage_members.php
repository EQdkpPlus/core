...
class Manage_Members extends page_generic {
	...
	public function display($messages=false){
		...
		$onclose_url = "if(event.originalEvent == undefined) { window.location.href = '".$this->root_path."admin/manage_members.php".$this->SID."'; } else { window.location.href = 'manage_members.php".$this->SID."'; }";
