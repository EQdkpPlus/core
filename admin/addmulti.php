...
class Add_MultiDKP extends EQdkp_Admin
{
    ...
    function process_add()
    {
        ...
        $sql = 'INSERT INTO __multidkp' . $query ;
        $db->query($sql);
    ...
    function add_multievents($this_multi_id, $events)
    {
        ...
        $db->query('INSERT INTO __multidkp2event' . $query);
    ...
    function process_update()
    {
        ...
        $db->query('UPDATE __multidkp SET ' . $query . " WHERE multidkp_id='" . $this->url_id . "'");

        //
        // Remove the old Events
        //
        $sql = 'DELETE FROM __multidkp2event
    ...
    function display_form()
    {
        ...
        // Build Eventlist
        //
        $sql = 'SELECT event_id, event_name	FROM __events';
