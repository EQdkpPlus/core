...
class Manage_Calevents extends page_generic {
	...
	public function display(){
		...
		$this->jquery->Dialog('newCalevent', $this->user->lang('calendar_win_add'), array('url'=>"../calendar/addevent.php?simple_head=true", 'width'=>'900', 'height'=>'580', 'onclose' =>$this->env->link.'admin/manage_calevents.php'));
		$this->jquery->Dialog('editEvent', $this->user->lang('calendar_win_edit'), array('url'=>"../calendar/addevent.php?eventid='+editid+'&simple_head=true", 'width'=>'900', 'height'=>'650', 'withid' => 'editid', 'onclose' => $this->env->link.'admin/manage_calevents.php'));
