...
class Manage_News extends page_generic {
	...
	public function edit(){
		...
		$this->tpl->assign_vars(array(
			...
			'DATE_TO_PICKER'			=> $this->jquery->Calendar('news_stop', $this->time->user_date(((strlen($this->news['news_stop'])) ? $this->news['news_date'] : 0), true, false, false, function_exists('date_create_from_format')), '', array('timepicker' => true)),
			'DATE_FROM_PICKER'			=> $this->jquery->Calendar('news_start', $this->time->user_date(((strlen($this->news['news_start'])) ? $this->news['news_date'] : 0), true, false, false, function_exists('date_create_from_format')), '', array('timepicker' => true)),
