...
class mmocms_settings extends page_generic {
	...
	public function display(){
		...
		$game_array = $this->jquery->dd_ajax_request('default_game', 'game_language', $games, array('--------'), $this->config->get('default_game'), 'manage_settings.php?ajax=games');
		$settingsdata = array(
			'global' => array(
				'global' => array(
