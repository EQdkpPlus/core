...
class ManageItems extends page_generic {
	...
	public function __construct(){
		$handler = array(
			'save' => array('process' => 'save', 'check' => 'a_item_add'),
		);
	...
	public function display($messages=false) {
		...
		$hptt = $this->get_hptt($hptt_page_settings, $view_list, $view_list, array('%link_url%' => 'manage_items.php', '%link_url_suffix%' => '&amp;upd=true', '%raid_link_url%' => 'manage_raids.php', '%raid_link_url_suffix%' => '&amp;upd=true', '%itt_lang%' => false, '%itt_direct%' => 0, '%onlyicon%' => 0));
