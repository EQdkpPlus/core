...
class Manage_Styles extends EQdkp_Admin
{
    ...
    function manage_styles()
    {
        ...
        $defaults = array(
            ...
            'logo_path'         => 'logo.gif',
            'classfontcolor_Warrior' 	=> 'C69B6D',
            'classfontcolor_Rogue' 		=> 'FFF468',
            'classfontcolor_Hunter' 	=> 'AAD372',
            'classfontcolor_Paladin'	=> 'F48CBA',
            'classfontcolor_Priest' 	=> 'FFFFFF',
            'classfontcolor_Druid' 	  => 'FF7C0A',
            'classfontcolor_Shaman' 	=> '00DBBA',
            'classfontcolor_Warlock' 	=> '9382C9',
            'classfontcolor_Mage' 		=> '68CCEF',
        ...
        $this->style = array(
            ...
            'classfontcolor_Warrior'  => post_or_db('classfontcolor_Warrior', $defaults),
            'classfontcolor_Rogue'    => post_or_db('classfontcolor_Rogue', $defaults),
            'classfontcolor_Hunter'   => post_or_db('classfontcolor_Hunter', $defaults),
            'classfontcolor_Paladin'  => post_or_db('classfontcolor_Paladin', $defaults),
            'classfontcolor_Priest'   => post_or_db('classfontcolor_Priest', $defaults),
            'classfontcolor_Druid'    => post_or_db('classfontcolor_Druid', $defaults),
            'classfontcolor_Shaman'   => post_or_db('classfontcolor_Shaman', $defaults),
            'classfontcolor_Warlock'  => post_or_db('classfontcolor_Warlock', $defaults),
            'classfontcolor_Mage'     => post_or_db('classfontcolor_Mage', $defaults)
        );
        ...
        if ( $this->url_id )
        {
            ...
            $this->style = array(
                ...
                'logo_path'          => post_or_db('logo_path', $row),
		            'classfontcolor_Warrior'  => post_or_db('classfontcolor_Warrior', $row),
    		        'classfontcolor_Rogue'    => post_or_db('classfontcolor_Rogue', $row),
        		    'classfontcolor_Hunter'   => post_or_db('classfontcolor_Hunter', $row),
		            'classfontcolor_Paladin'  => post_or_db('classfontcolor_Paladin', $row),
            		'classfontcolor_Priest'   => post_or_db('classfontcolor_Priest', $row),
            		'classfontcolor_Druid'    => post_or_db('classfontcolor_Druid', $row),
            		'classfontcolor_Shaman'   => post_or_db('classfontcolor_Shaman', $row),
            		'classfontcolor_Warlock'  => post_or_db('classfontcolor_Warlock', $row),
            		'classfontcolor_Mage'     => post_or_db('classfontcolor_Mage', $row)
    ...
    function process_add()
    {
        ...
        $query = $db->build_query('INSERT', array(
            ...
            'classfontcolor_Warrior' => $classfontcolor_Warrior,
            'classfontcolor_Rogue'   => $classfontcolor_Rogue,
            'classfontcolor_Hunter'  => $classfontcolor_Hunter,
            'classfontcolor_Paladin' => $classfontcolor_Paladin,
            'classfontcolor_Priest'  => $classfontcolor_Priest,
            'classfontcolor_Druid'   => $classfontcolor_Druid,
            'classfontcolor_Shaman'  => $classfontcolor_Shaman,
            'classfontcolor_Warlock' => $classfontcolor_Warlock,
            'classfontcolor_Mage'    => $classfontcolor_Mage
    ...
    function display_form()
    {
        ...
        $tpl->assign_vars(array(
            ...
            'CLASSFONTCOLOR_WARRIOR'    => $this->style['classfontcolor_Warrior'],
            'CLASSFONTCOLOR_ROGUE'      => $this->style['classfontcolor_Rogue'],
            'CLASSFONTCOLOR_HUNTER'     => $this->style['classfontcolor_Hunter'],
            'CLASSFONTCOLOR_PALADIN'    => $this->style['classfontcolor_Paladin'],
            'CLASSFONTCOLOR_PRIEST'     => $this->style['classfontcolor_Priest'],
            'CLASSFONTCOLOR_DRUID'      => $this->style['classfontcolor_Druid'],
            'CLASSFONTCOLOR_SHAMAN'     => $this->style['classfontcolor_Shaman'],
            'CLASSFONTCOLOR_WARLOCK'    => $this->style['classfontcolor_Warlock'],
            'CLASSFONTCOLOR_MAGE'       => $this->style['classfontcolor_Mage'],
            ...
            'L_FONTCOLOR'          		 => $user->lang['fontcolor'],
            'L_WARRIOR'           		 => $user->lang['Warrior'],
            'L_ROGUE'           			 => $user->lang['Rogue'],
            'L_HUNTER'           			 => $user->lang['Hunter'],
            'L_PALADIN'           		 => $user->lang['Paladin'],
            'L_PRIEST'           			 => $user->lang['Priest'],
            'L_DRUID'           			 => $user->lang['Druid'],
            'L_SHAMAN'           			 => $user->lang['Shaman'],
            'L_WARLOCK'           		 => $user->lang['Warlock'],
            'L_MAGE'           				 => $user->lang['Mage'],
