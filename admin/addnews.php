...
class Add_News extends EQdkp_Admin
{
    ...
    function add_news()
    {
      ...
      'news_permissions'  => post_or_db('news_permissions')
        ...
        if ( $this->url_id )
        {
            $sql = 'SELECT news_headline, news_message, showRaids_id, extended_message, nocomments, news_permissions
                    FROM ' . NEWS_TABLE . "
    ...
    function process_add()
    {
        ...
        $query = $db->build_query('INSERT', array(
            ...
            'extended_message'   => stripslashes($_POST['extended_message']),
    ...
    function get_old_data()
    {
        ...
        $sql = 'SELECT news_headline, news_message, showRaids_id, extended_message, news_permissions, nocomments
                FROM ' . NEWS_TABLE . "
                WHERE news_id='" . $this->url_id . "'";
        $result = $db->query($sql);
    ...
    function display_form()
    {
        ...
        $tpl->assign_vars(array(
            ...
            'MESSAGE_EXT'  => stripmultslashes($this->news['extended_message']),
            ...
            'L_UPDATE_DATE_TO' => sprintf($user->lang['update_date_to'], date('m/d/y h:ia T', time())),
             ...
             'L_NEWS_EXT_MSG' => $user->lang['news_ext_message'],
            ...
            'WYSIWYG_LONG'  => $jqueryp->wysiwyg('longinput'),
