...
class Manage_Portal extends page_generic {
	...
	public function __construct() {
		$handler = array(
			...
			'save_sett' => array('process' => 'save_settings'),
	...
	public function display() {
		...
		$this->confirm_delete($this->user->lang('portal_delete_warn'), 'manage_portal.php'.$this->SID.'&session_key='.$this->user->data['session_key'].'&del=true', true, array('function' => 'delete_portal'));
		...
		$this->jquery->Dialog('portalsettings', $this->user->lang('portalplugin_winname'), array('url'=>$this->root_path."admin/manage_portal.php?simple_head=true&reload=1&id='+moduleid+'", 'width'=>'660', 'height'=>'400', 'withid'=>'moduleid', 'onclose' => 'manage_portal.php'.$this->SID));
		$this->tpl->add_css(".portal_disabled { float:left; margin-left: 4px; width:230px; height: 16px;}");
		$this->core->set_vars(array(
			'page_title'		=> $this->user->lang('portalplugin_management'),
