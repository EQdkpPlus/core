...
class Manage_Game extends EQdkp_Admin
{
 function do_it()
 {
   ...
   "INSERT INTO ". $table_prefix ."classes (class_id, class_name, class_armor_type, class_min_level, class_max_level) VALUES (1, 'Krieger', 'Schwere Rüstung',0,39);",
   ...
   "INSERT INTO ". $table_prefix ."classes (class_id, class_name, class_armor_type, class_min_level, class_max_level) VALUES (5, 'Paladin', 'Schwere Rüstung',0,39);",
