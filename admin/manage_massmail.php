...
class Manage_Massmail extends page_generic {
	public static function __shortcuts() {
		$shortcuts = array('user', 'tpl', 'in', 'pdh', 'jquery', 'core', 'config', 'pm', 'time', 'env', 'email'=>'MyMailer', 'crypt'=>'encrypt', 'html', 'time', 'logs');
	...
	public function __construct(){
		...
		$handler = array(
			...
			'send'	=> array('process' => 'process_send', 'session_key' => true),
	...
	public function process_data(){
		...
		//Plugin Hooks
		$arrPluginsHooks = $this->pm->do_hooks('massmail_content');
	...
	public function process_send(){
		...
		if (strlen($this->pdh->get('user', 'email', array($userid)))){
			$options = array(
				'template_type'		=> 'input',
			);
