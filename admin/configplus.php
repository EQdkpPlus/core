...
class Add_MultiDKP extends EQdkp_Admin
{
    ...
    function process_add()
    {
        ...
        $query = $db->build_query('INSERT', array(
            'multidkp_name'     => $_POST['multidkp_name'],
            'multidkp_disc'     => $_POST['multidkp_disc']
            )
        );
        $db->query('INSERT INTO ' . MULTIDKP_TABLE . $query);
        ...
        //
        #$log_action = array(
        #    'header'         => '{L_ACTION_MULTI_ADDED}',
        #    '{L_MULTINAME}' => $_POST['adjustment_value'],
        #    '{L_MULTIDISC}'     => stripslashes($_POST['adjustment_reason']),            
