...
class Manage_User_Groups extends page_generic {
	...
	public function __construct(){
		...
		$handler = array(
			'save' => array('process' => 'user_group_save'),
			'del_group_users' => array('process' => 'user_group_users_del'),
			'add_group_users' => array('process' => 'user_group_users_save'),
			'save_group_perms' => array('process' => 'save_group_permissions'),
