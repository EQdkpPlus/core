...
{
	$v1 = intval(str_replace('.','',$row['config_value']));
	$v2 = intval(str_replace('.','','0.6.1.6'));

	if ($v1 >= $v2)
	{
		$a_system['616']['state'] = 1 ;
	}
}
...
{
	$v1 = intval(str_replace('.','',$row['config_value']));
	$v2 = intval(str_replace('.','','0.6.2.0'));

	if ($v1 >= $v2)
	{
		$a_system['620']['state'] = 1 ;
	}
}
...
{
	$v1 = intval(str_replace('.','',$row['config_value']));
	$v2 = intval(str_replace('.','','0.6.2.1'));

	if ($v1 >= $v2)
	{
		$a_system['621']['state'] = 1 ;
	}
}
...
{
	$v1 = intval(str_replace('.','',$row['config_value']));
	$v2 = intval(str_replace('.','','0.6.2.2'));

	if ($v1 >= $v2)
	{
		$a_system['622']['state'] = 1 ;
	}
}
