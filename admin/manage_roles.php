...
class Manage_Roles extends page_generic {
	...
	public function __construct(){
		...
		$handler = array(
			...
			'reset'		=> array('process' => 'process_reset')
		);
	...
	public function display(){
		...
		$this->jquery->Dialog('newRole', $this->user->lang('role_new'), array('url'=>"manage_roles.php?adddialog=true", 'width'=>'600', 'height'=>'260'));
		$this->jquery->Dialog('editRole', $this->user->lang('edit_role2'), array('url'=>"manage_roles.php?editid='+editid+'", 'width'=>'600', 'height'=>'260', 'withid' => 'editid'));
		$this->jquery->Dialog('ResetRoles', '', array('custom_js'=> "window.location = 'manage_roles.php?reset=true';", 'message'=> $this->user->lang('reset_rolestext')), 'confirm');
