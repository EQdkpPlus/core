...
if ($show_inline and (strlen($conf_plus['pk_bridge_cms_InlineUrl']) > 0) )
{
	$forum_out = '<script type="text/javascript">
	  ...
	  $forum_out .= $conf_plus['pk_bridge_cms_InlineUrl'];
...
}elseif ($show_inline == false)
{

	define('DKP_URL', 'http://localhost/eqdkp/forum.php');
	define('BOARD_URL', 'http://localhost/smf/index.php');

	define('SMF_INTEGRATION_SETTINGS', serialize(array(
		'integrate_exit' => 'eqdkp_smf_exit',
		'integrate_redirect' => 'integrate_redirect',
		'integrate_register' => 'integrate_register',
	)));

	ob_start('ob_eqdkpfix');
	ob_start();
	require(dirname(__FILE__).'/../smf/index.php');
