...
<caption>
	<span class="unmodified">&nbsp;</span> ' . register('user')->lang('liveupdate_diff_unmodified') . '
	<span class="added">&nbsp;</span> ' .register('user')->lang('liveupdate_diff_added') . '
	<span class="modified">&nbsp;</span> ' . register('user')->lang('liveupdate_diff_modified') . '
	<span class="removed">&nbsp;</span> ' . register('user')->lang('liveupdate_diff_removed') . '
</caption>
<tbody>
';
		...
		else
		{
			...
			{
				$output .= '<tr><th>' . register('user')->lang('liveupdate_diff_line') . ' ' . $header['oldline'] . '</th><th>' . register('user')->lang('liveupdate_diff_line') . ' ' . $header['newline'] . '</th></tr>';
