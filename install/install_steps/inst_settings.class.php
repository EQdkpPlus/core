...
class inst_settings extends install_generic {
	...
	private $config_data		= array(
		...
		'auth_method'					=> 'db',
		'sort_menu1' => 'a:8:{s:12:"viewnews.php";a:2:{s:4:"sort";i:0;s:4:"hide";N;}s:12:"calendar.php";a:2:{s:4:"sort";i:1;s:4:"hide";N;}s:18:"listcharacters.php";a:2:{s:4:"sort";i:2;s:4:"hide";N;}s:10:"roster.php";a:2:{s:4:"sort";i:3;s:4:"hide";N;}s:13:"listraids.php";a:2:{s:4:"sort";i:4;s:4:"hide";N;}s:14:"listevents.php";a:2:{s:4:"sort";i:5;s:4:"hide";N;}s:13:"listitems.php";a:2:{s:4:"sort";i:6;s:4:"hide";N;}s:13:"listusers.php";a:2:{s:4:"sort";i:8;s:4:"hide";N;}}',
		'eqdkpm_shownote'				=> '1',
	...
	public function get_output() {
		...
		if(!$this->def_server_path) $this->def_server_path = str_replace('install/index.php', '', $_SERVER['PHP_SELF']);
		...
		foreach($timezone_ab as $more_data) {
			foreach($more_data as $tz) {
				...
				$offset = '';
				if($tz['offset']) $offset = '   (GMT '.(($tz['offset'] > 0) ? '+' : '-').($tz['offset']/3600).')';
		...
		$content = '<table class="ui-widget" style="border-collapse: collapse;" width="100%">
						...
						<tr>
							...
							<td>'.$this->html->DropDown('timezone', $timezones, $this->def_timezone).'</td>
						</tr>
						<tr>
	...
	private function install_permissions() {
		...
		$b[] = $this->InsertGroupPermissions(4, array('u_event_view', 'u_item_view', 'u_raid_view', 'u_member_view', 'u_member_man', 'u_member_add', 'u_member_conn', 'u_member_del', 'u_userlist', 'u_calendar_view', 'u_news_view', 'u_search', 'u_usermailer'));
