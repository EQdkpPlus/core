...
function process_step1()
{
    ...
    // PHP Versions
    $our_php_version   = (( phpversion() >= '4.2.0' ) ? '<span class="positive">' : '<span class="negative">') . phpversion() . '</span>';
    $their_php_version = '4.2.0+';
    ...
    if ( (phpversion() < '4.2.0') || (!extension_loaded('mysql')) )
    {
...
function process_step5()
{
    ...
    //
    $db->query("UPDATE __config SET config_name='eqdkp_start' WHERE config_name='" . $table_prefix . "start'");
    $db->query("UPDATE __config SET config_value='".$server_name."' WHERE config_name='server_name'");
    $db->query("UPDATE __config SET config_value='".$server_port."' WHERE config_name='server_port'");
    $db->query("UPDATE __config SET config_value='".$server_path."' WHERE config_name='server_path'");
    $db->query("UPDATE __config SET config_value='".$default_lang."' WHERE config_name='default_lang'");
    $db->query("UPDATE __config SET config_value='".$default_locale."' WHERE config_name='default_locale'");
...
function process_step6()
{
    ...
    $sql = "SELECT config_value FROM __config WHERE config_name='default_lang'";
    ...
    $db->query('UPDATE __users SET ' . $query . " WHERE user_id='1'");

    $db->query("UPDATE __config SET config_value='".$user_email."' WHERE config_name='admin_email'");
