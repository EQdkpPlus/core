...
function process_step1()
{
    ...
    if ( (phpversion() < REQUIRED_PHP_VERSION) || (!extension_loaded('mysql')) || (!extension_loaded('zlib')))
    {
...
function process_step5()
{
    ...
    // fix for replacing type in engine if mysql version is higher than 5.4
	if(version_compare(mysql_get_server_info(), '5.5.0', '>=')){
