...
INSERT INTO eqdkp_config (config_name, config_value) VALUES ('plus_version', '0.6.4.10');
...
#bad_cataclysm
INSERT INTO `eqdkp_styles` (`style_id`, `style_name`, `template_path`, `body_background`, `body_link`, `body_link_style`, `body_hlink`, `body_hlink_style`, `header_link`, `header_link_style`, `header_hlink`, `header_hlink_style`, `tr_color1`, `tr_color2`, `th_color1`, `fontface1`, `fontface2`, `fontface3`, `fontsize1`, `fontsize2`, `fontsize3`, `fontcolor1`, `fontcolor2`, `fontcolor3`, `fontcolor_neg`, `fontcolor_pos`, `table_border_width`, `table_border_color`, `table_border_style`, `input_color`, `input_border_width`, `input_border_color`, `input_border_style`) VALUES (38, 'Bad Cataclysm', 'bad_cataclysm', '', 'E59900', 'none', 'FF6633', 'none', 'FFCC00', 'none', 'FF6633', 'underline', '4C4C4C', '7F7F7F', '000000', 'Verdana, Arial, Helvetica, sans-serif', 'Verdana, Arial, Helvetica, sans-serif', 'Verdana, Arial, Helvetica, sans-serif', 10, 11, 18, 'E59900', 'E59900', '000000', 'FF0000', '008800', 0, 'EEEEEE', 'solid', 'EEEEEE', 1, '000000', 'solid');

#cataclysm_allvatar
INSERT INTO `eqdkp_styles` VALUES(39, 'cataclysm_allvatar', 'cataclysm_allvatar', '2B577C', 'C3E5FF', 'none', 'EEEEEE', 'none', 'FFFFFF', 'none', 'C3E5FF', 'none', '14293B', '1D3953', '2B577C', 'Verdana, Arial, Helvetica, sans-serif', 'Verdana, Arial, Helvetica, sans-serif', 'Verdana, Arial, Helvetica, sans-serif', 11, 12, 13, 'EEEEEE', 'C3E5FF', '000000', 'FF0000', '008800', 1, '999999', 'solid', 'EEEEEE', 1, '2B577C', 'solid');


### Style configurations
#default
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (1, '6',  'logo_plus.gif', '', '');

#Old School
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (2, '4',  'logo_plus.gif', '', '');

#EQdkp VB
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (3, '6',  'logo_plus.gif', '', '');

#Blueish
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (4, '6',  'logo_plus.gif', '', '');

#EQdkp Items
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (5, '6',  'logo_plus.gif', '', '');

#aallix Silver
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (6, '6',  'logo_plus.gif', '', '');

#Penguin
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (7, '6',  'logo_plus.gif', '', '');

#Collab
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (8, '6',  'logo_plus.gif', '', '');

#EQdkp Invision
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (9, '6',  'logo_plus.gif', '', '');

#dkpUA
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (10, '8', 'logo_plus.gif', '', '');

#subSilver
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (11, '8', 'logo_plus.gif', '', '');

#EQdkp VB2
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (12, '8', 'logo_plus.gif', '', '');

#EQCPS
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (13, '8', 'logo_plus.gif', '', '');

#wow_style
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (14, '6', '/logo/logo_wow.gif', '', '');

#WoWMoonclaw01
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (15, '8', 'logo_wow.gif', '', '');

#WoWMaevahEmpire
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (16, '6', 'logo_wow.gif', '', '');

#Default_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (17, '6', 'bc_header3.gif', '', '');

#Old_School_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (18, '4', 'bc_header3.gif', '', '');

#EQdkp VB_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (19, '6', 'bc_header3.gif', '', '');

#Blueish_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (20, '6', 'bc_header3.gif', '', '');

#EQdkp Items_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (21, '6', 'bc_header3.gif', '', '');

#aallix Silver_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (22, '6', 'bc_header3.gif', '', '');

#Penguin_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (23, '6', 'bc_header3.gif', '', '');

#Collab_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (24, '6', 'bc_header3.gif', '', '');

#EQdkp Invision_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (25, '6', 'bc_header3.gif', '', '');

#dkpUA_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (26, '8', 'bc_header3.gif', '', '');

#subSilver_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (27, '8', 'bc_header3.gif', '', '');

#EQdkp VB2_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (28, '8', 'bc_header3.gif', '', '');

#EQCPS_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (29, '8', 'bc_header3.gif', '', '');

#wow_style_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (30, '6', '/logo/logo_wow.gif', '', '');

#WoWMoonclaw01_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (31, '8', 'bc_header3.gif', '', '');

#WoWMaevahEmpire_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (32, '6', 'bc_header3.gif', '', '');

#wow_Vert
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (33, '6', '/logo/logo_wow.gif', '', '');

#m9wow
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (35, '6', 'wowlogo3.png', '', '');

#luna_wotlk
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (36, '6', 'logo.png', '', '');

#m9wow
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (37, '6', 'wowlogo3.png', '', '');

#bad_cataclysm
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (38, '6', 'logo.png', '', '');

#cataclysm_allvatar
INSERT INTO eqdkp_style_config (style_id, attendees_columns, logo_path, background_img, css_file ) VALUES (39, '6', 'logo.png', '', '');

### Default user
INSERT INTO eqdkp_users (user_id, username, user_password, user_style, user_lang, user_active, privacy_settings) VALUES ('1','admin',md5('admin'),'36','english','0', '');
...
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(6, 'RankImage Module', '0', '1', 'rankimage', 'corgan@eqdkp-plus.com', NULL, NULL, '1.0.0', 'right', 4, '', '0', '1');
...
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(18, 'QuickSearch', '0', '1', 'quicksearch', NULL, NULL, NULL, '', 'left2', 4, '', '0', '1');
...
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(20, 'Counter-Module', '0', '1', 'advancedcounter', NULL, NULL, NULL, '', 'left1', 20, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(21, 'Amazon Modul', '0', '1', 'amazon', NULL, NULL, NULL, '', 'right', 13, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(22, 'Battle of the Best (WoW)', '0', '1', 'battleofthebest', NULL, NULL, NULL, '', 'right', 1, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(23, 'Birthdays', '1', '1', 'birthday', NULL, NULL, NULL, '', 'left2', 10, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(24, 'Counter-Module', '0', '1', 'counter', NULL, NULL, NULL, '', 'left1', 20, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(25, 'Gametimecards', '1', '0', 'gametimecard', NULL, NULL, NULL, '', 'right', 1, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(26, 'Guildox Modul', '0', '1', 'guildox', NULL, NULL, NULL, '', 'right', 12, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(27, 'Member Map', '0', '1', 'membermap', NULL, NULL, NULL, '', 'left2', 11, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(28, 'Mini Games Module', '0', '1', 'minigames', NULL, NULL, NULL, '', 'right', 14, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(29, 'Officer Conference', '0', '1', 'offi_conf', NULL, NULL, NULL, '', 'left2', 5, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(30, 'RSS Feed', '0', '1', 'rssfeed', NULL, NULL, NULL, '', 'left2', 9, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(31, 'Teamspeak3 Module', '0', '1', 'teamspeak3', NULL, NULL, NULL, '', 'left2', 15, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(32, 'Twitter-Reader', '0', '1', 'twitter', NULL, NULL, NULL, '', 'left1', 1, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(33, 'Weather', '0', '1', 'weather', NULL, NULL, NULL, '', 'left2', 11, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(34, 'Word of the Moment', '0', '1', 'wordofthemoment', NULL, NULL, NULL, '', 'right', 7, '', '0', '1');
INSERT INTO eqdkp_portal (id, name, enabled, settings, path, contact, url, autor, version, position, number, plugin, visibility, collapsable) VALUES(35, 'Guild rating', '0', '1', 'wowprogress', NULL, NULL, NULL, '', 'right', 4, '', '0', '1');

INSERT INTO eqdkp_plus_config (config_name, config_value) VALUES('pk_bossguides_hide_citadel', '1');
INSERT INTO eqdkp_plus_config (config_name, config_value) VALUES('pk_bossguides_hide_crusader', '1');
INSERT INTO eqdkp_plus_config (config_name, config_value) VALUES('pk_bossguides_hide_malygos', '1');
INSERT INTO eqdkp_plus_config (config_name, config_value) VALUES('pk_bossguides_hide_naxx', '1');
INSERT INTO eqdkp_plus_config (config_name, config_value) VALUES('pk_bossguides_hide_ruby', '1');
INSERT INTO eqdkp_plus_config (config_name, config_value) VALUES('pk_bossguides_hide_sartharion', '1');
INSERT INTO eqdkp_plus_config (config_name, config_value) VALUES('pk_bossguides_hide_ulduar', '1');
