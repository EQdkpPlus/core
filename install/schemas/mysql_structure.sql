...
CREATE TABLE `eqdkp_users` (
  ...
  `allvatar_nick` VARCHAR( 255 ) NOT NULL ,
  `icq` VARCHAR( 255 ) NOT NULL ,
  `skype` VARCHAR( 255 ) NOT NULL ,
  `msn` VARCHAR( 255 ) NOT NULL ,
  `irq` VARCHAR( 255 ) NOT NULL ,
...
CREATE TABLE IF NOT EXISTS eqdkp_data_cache (
      `id` int(11) unsigned NOT NULL auto_increment,
...
### Plus Data Handler PDH Preset aliases
DROP TABLE IF EXISTS eqdkp_pdh_preset_aliases;
CREATE TABLE IF NOT EXISTS eqdkp_pdh_preset_aliases (
      `id` int(11) unsigned NOT NULL auto_increment,
