...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="{L_XML_LANG}" lang="{L_XML_LANG}">
	...
	<body>
		...
		<div id="header">
			<div id="personalArea">
				<div id="personalAreaLogin">
					...
					&nbsp;&bull;&nbsp; <a href="{EQDKP_ROOT_PATH}login.php{SID}&amp;logout=true"><img src="{EQDKP_IMAGE_PATH}glyphs/logout.png" alt="user" class="absmiddle" /> {L_logout}</a>
		...
		<div id="wrapper" <!-- IF T_PORTAL_WIDTH -->class="fixed_width"<!-- ENDIF -->>
			...
			<div class="wrapperBGRight">
		<div class="wrapperBGLeft">
				<a name="content"></a>
				<!-- IF S_IN_ADMIN -->
				<div id="adminmenu">
					{ADMIN_MENU}
			...
			</div> <!-- close wrapperBGLeft -->
			</div> <!-- close wrapperBGRight -->
		...
		<div id="footer">
			...
			<div id="gw2copy">
				<div id="ncsoft_logo"><img src="{TEMPLATE_PATH}/images/ncsoft.png" alt="ncsoft" /></div>
				<div id="arenanet_logo"><img src="{TEMPLATE_PATH}/images/arenanet.png" alt="arenanet" /></div>
				<div id="gw2_copytext">
