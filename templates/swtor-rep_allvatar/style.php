...
input.button, input.liteoption, input.mainoption {
	...
	/*background:#EEEEEE;*/
	border: #000000 solid 0px;;
	border-bottom: solid 0px #1862af;
	border-right: solid 0px #1862af;
...
#rrs_news div.title {
	...
	font-size: 11px;
	color: #ffffff;
	background: #215d7f url(images/head.jpg) repeat-x top;
	border: 0px solid #215d7f;
}

#rrs_news div.title:hover {
	color: #ffffff;
	background: #2f89bb url(images/head_hl.jpg) repeat-x top;
}
