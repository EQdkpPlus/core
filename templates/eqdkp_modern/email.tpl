<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="font-size: 13px;font-family: Tahoma, Arial, Verdana, sans-serif;color: #000;padding: 0;margin: 0;height: 100%">
		<div id="header" style="background: linear-gradient(to bottom, #2e78b0 0%, #193759 100%);">
			<div id="innerHeader" style="font-family: &quot;Trebuchet MS&quot;, Arial, sans-serif;vertical-align: middle;height: 120px;margin: 0 auto">
				...
				<div style="float:left;font-size: 40px;font-weight: bold;text-shadow: 1px 1px 2px #fff;color:#fff;">{GUILDTAG}</div></div>
		</div>
		
		<div id="main" style="overflow: auto;margin: 0 auto; padding: 10px">
		...
		<div id="footer" style="margin-top: 1em; font-size: 12px; background-color: #193759; color: #fff; padding: 10px;">
			{SIGNATURE}
			<br /><br />
