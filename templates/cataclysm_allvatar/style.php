...
th {
	background:#1a1919 url(images/headline-area.jpg) no-repeat;
   background-position:right;
   background-image: url(images/headline-area.jpg) no-repeat;
	color:#FFF;
	font-size: 12px;
	font-family: Verdana, Arial, Helvetica, sans-serif;
	height:30px;
	...
	padding-left:8px;
	padding-right:8px;
	border-top:1px solid #D5261B;
	border-bottom:1px solid #D5261B;
}
