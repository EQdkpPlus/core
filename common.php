...
$lotro_classes = array("classes", "burglar", "captain","champion","guardian","hunter","lore-master","minstrel",
					  			  "schurke","hauptmann","waffenmeister","wächter","jäger","kundiger","barde");

$wow_classes = array("classes", "Druide","Hexenmeister","Jäger","Krieger","Magier","Paladin","Priester","Schurke","Schamane","Unknown",
								"Druid","Warlock","Hunter","Warrior","Mage","Paladin","Priest","Rogue","Shaman","Default",);
$tpl   	 = new Template;
...
#define('ABS_PATH',	 ($_SERVER['PHP_SELF']).'/');
#d(ABS_PATH);
#define('ABS_PATH',	 (__FILE__).'/');
#d(ABS_PATH);
...
getDKPInfo(); #dkp, player, items anzeige link #ToDo -> bridge class
	...
	*/
	...
	function myErrorHandler($errno, $errstr, $errfile, $errline)
	{
	 global $debug;
	  ...
	  {
	  	echo "<b>Unkown error type: </b> [$errno] $errstr<br /> <b>File:</b> $errfile <br>  <b>line: </b>$errline <br><br> \n";
	  }
