...
//PLUS CONSTANTS
require_once($eqdkp_root_path . '/includes/plusversion.php');
// version is now outsourced.. see includes/plusversion.php
// this is because i use it in the installer. think its a good
// solution :)
...
{
	getDKPInfo(); #dkp, player, items anzeige link
}
