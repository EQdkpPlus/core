...
$comments = new rpComments(COMMENTS_TABLE);
...
//RSS Parser
if((!$conf_plus['pk_showRss'] == 1) and ($user->data['user_lang'] == 'german'))
{
...
if ($conf_plus['pk_recruitment_active']==1) {
	$html->createRecruitmentTable();
}

//NextRaids und lastitems deactivate until the release of Eqdkp Plus 0.6!
#next Raids
#if ($conf_plus['pk_nextraids_deactive']==0) {
#	$html->getNextRaids();
#}

#last items
#if ($conf_plus['pk_last_items_deactive']==0) {
#	$html->createLastItems();
#}
