...
//PLUS CONSTANTS
define('EQDKPPLUS_VERSION', '0.4.2.0');
define('EQDKPPLUS_AUTHOR', 'Corgan');
define('EQDKPPLUS_AUTHOR_URL', 'http://eqdkp.corgan-net.de/wiki/index.php/Benutzer:Corgan');

$eqdkpplus_vcontrol = array('pluskernel','raidbanker','itemspecials','charmanager');
