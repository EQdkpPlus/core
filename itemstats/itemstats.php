...
{
	include_once(dirname(__FILE__) . '/includes_de/itemcache.php');
	include_once(dirname(__FILE__) . '/includes_de/blasc.php');
}
else
{
	include_once(dirname(__FILE__) . '/includes_eng/itemcache.php');
	include_once(dirname(__FILE__) . '/includes_eng/allakhazam.php');
}
