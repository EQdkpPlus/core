...
function itemstats_decorate_name($name,$id=0,$onlyIcon=false, $update=false, $urlOnly=false, $itemcolorOnly = false)
{
	global $conf_plus , $eqdkp_root_path, $item_stats;
	global $item_stats_time, $item_stats_max_time;
	
	$item_color = $item_icon_link = '';
