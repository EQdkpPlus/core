	...
	function getItem($name)
    {
		...
		for ($ct = 0; isset($GLOBALS["allakhazam_lang"][$ct]); $ct++)
		{
	        ...
	        if ($item_found)
			{
				...
				$item['html'] = str_replace('/images/bluesocket.png', "./images/sockets/socket_blue.gif", $item['html']);
				$item['html'] = str_replace('/images/redsocket.png',  "./images/sockets/socket_red.gif", $item['html']);
				$item['html'] = str_replace('/images/yellowsocket.png', "./images/sockets/socket_yellow.gif", $item['html']);
				$item['html'] = str_replace('/images/metasocket.png', "./images/sockets/socket_meta.gif", $item['html']);
