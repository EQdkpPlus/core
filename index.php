...
class controller extends gen_class {
	...
	public function display(){
		...
		if ($strPageObject){
			$this->displayPageobject($strPageObject);
		} else {
		...
		//Check if direct pageobject
		$this->routing->scanCorePageobjects();
		$arrPageObject = $this->routing->getPageObject($arrPath[0]);
		if(isset($arrPageObject->blnDirectView) && $arrPageObject->blnDirectView){
			$this->displayPageobject($arrPath[0]);
		}
