	...
	public function edit(){
		...
		if ($id){
			...
			$this->tpl->assign_vars(array(
				...
				'DD_CATEGORY'		=> (new hdropdown('category', array('options' => $arrCategories, 'value' => $this->pdh->get('articles', 'category', array($id)))))->output(),
		...
		$this->tpl->assign_vars(array(
			...
			'DD_PAGE_OBJECTS'	=> (new hdropdown('page_objects', array('options' => $arrPageObjects)))->output(),
