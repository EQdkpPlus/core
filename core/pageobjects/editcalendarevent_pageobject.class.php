...
class editcalendarevent_pageobject extends pageobject {
	...
	public function display() {
		...
		$this->tpl->assign_vars(array(
			...
			'DR_SHARE_USERS'	=> new hmultiselect('invited', array('options' => $this->pdh->aget('user', 'name', 0, array($this->pdh->get('user', 'id_list'))), 'value' => ((isset($eventdata['extension']) && $eventdata['extension']['invited']) ? $eventdata['extension']['invited'] : array()) ), 'jq_options' => array('filter' => true)),
