...
class mycharacters_pageobject extends pageobject {
	...
	public function display(){
		...
		$this->jquery->Dialog('EditChar', $this->user->lang('uc_edit_char'), array('withid'=>'editid', 'url'=> $this->controller_path.'AddCharacter/'.$this->SID."&editid='+editid+'", 'width'=>'640', 'height'=>'600', 'onclose'=>$this->controller_path.'AddCharacter/'.$this->SID));
