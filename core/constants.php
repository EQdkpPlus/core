 ...
 * -------------------------------------------------------------------------
 */
define('VERSION_INT',		'2.1.3.0');			// the internal version number for updates & update check
define('VERSION_EXT',		'2.1.3');		// the external version number to be shown in the footer
