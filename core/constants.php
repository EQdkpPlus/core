 ...
 * -------------------------------------------------------------------------
 */
define('VERSION_INT',		'2.2.0.1');			// the internal version number for updates & update check
define('VERSION_EXT',		'2.2.0 Dev');		// the external version number to be shown in the footer
