 ...
 * -------------------------------------------------------------------------
 */
define('VERSION_INT',		'2.0.0.25');			// the internal version number for updates & update check
define('VERSION_EXT',		'2.0.0');				// the external version number to be shown in the footer
