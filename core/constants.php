...
define('VERSION_INT',		'2.3.29.0');				// the internal version number for updates & update check
define('VERSION_EXT',		'2.3.29');				// the external version number to be shown in the footer
