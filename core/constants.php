...
define('VERSION_INT',		'2.3.18.0');				// the internal version number for updates & update check
define('VERSION_EXT',		'2.3.18');				// the external version number to be shown in the footer
