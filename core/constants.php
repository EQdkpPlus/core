 ...
 * -------------------------------------------------------------------------
 */
define('VERSION_INT',		'2.1.0.9');			// the internal version number for updates & update check
define('VERSION_EXT',		'2.1.0');		// the external version number to be shown in the footer
