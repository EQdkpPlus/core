 ...
 * -------------------------------------------------------------------------
 */
define('VERSION_INT',		'1.0.22');				// the internal version number for updates & update check
define('VERSION_EXT',		'1.0.5');				// the external version number to be shown in the footer
