...
define('VERSION_INT',		'2.3.8.0');				// the internal version number for updates & update check
define('VERSION_EXT',		'2.3.8');				// the external version number to be shown in the footer
