 ...
 * -------------------------------------------------------------------------
 */
define('VERSION_INT',		'1.0.2');				// the internal version number for updates & update check
define('VERSION_EXT',		'1.0 Beta 3');			// the external version number to be shown in the footer
...
define('EQDKP_TWITTER_URL', "http://eqdkp-plus.eu/rss/twitter.json");
