 ...
 * -------------------------------------------------------------------------
 */
define('VERSION_INT',		'1.0.0');				// the internal version number for updates & update check
define('VERSION_EXT',		'1.0 Beta 1');			// the external version number to be shown in the footer
...
define('EQDKP_TWITTER_URL', "http://eqdkp-plus.eu/rss/twitter.xml");
