 ...
 * -------------------------------------------------------------------------
 */
define('VERSION_INT',		'2.2.27.0');				// the internal version number for updates & update check
define('VERSION_EXT',		'2.2.27');			// the external version number to be shown in the footer
