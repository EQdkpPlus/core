 ...
 * -------------------------------------------------------------------------
 */
define('VERSION_INT',		'2.1.0.8');			// the internal version number for updates & update check
define('VERSION_EXT',		'2.1.0 Beta 1');		// the external version number to be shown in the footer
