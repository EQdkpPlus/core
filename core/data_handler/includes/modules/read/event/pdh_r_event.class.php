...
if(!class_exists('pdh_r_event')){
	class pdh_r_event extends pdh_r_generic{
		public static function __shortcuts() {
			$shortcuts = array('pdc', 'db', 'user', 'pdh', 'config'	);
		...
		public function get_html_icon($event_id, $width=16, $height=16, $alt=true, $no_root=false){
			return "<img src='".$this->get_icon($event_id, true, true, $no_root)."' width='".$width."' height='".$height."' ".(($alt) ? " alt='".$this->get_name($event_id)."'" : "alt=''")." />";
		}
