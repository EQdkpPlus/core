...
// Begin
    ...
    $mySearch = htmlentities(strip_tags($_GET['search']), ENT_QUOTES);
    
    $u_list_items = 'itemsearch.php'.$SID.'&amp;search=' . $mySearch . '&amp;search_type=' . $_GET['search_type'] . '&amp;unique_result=' . $_GET['unique_result'] . '&amp;';
...
if (isset($mySearch))
{
	if ($_GET['search_type'] == 'itemname')
		...
		$search_type = '__items.raid_id = __raids.raid_id AND raid_name';
		$search_table = '__items, __raids';
	}
	$search_set = true;
    ...
    $pagination = generate_pagination('itemsearch.php'.$SID.'&amp;search=' . $mySearch . '&amp;search_type=' . $_GET['search_type'] . '&amp;unique_result=' . $_GET['unique_result'] . '&amp;o='.$current_order['uri']['current'],
