	...
	public function display(){
		...
		$this->tpl->add_js("
			...
			$('.cdefroledd').change( function(){
				$.post('characters.php".$this->SID."&link_hash=".$this->CSRFGetToken('maincharchange')."', { defrolechange: $(this).val(), defrolechange_memberid: $(this).attr('name').replace('defaultrole_', '') },
					function(data){
						$('#notify_container').notify('create', data);
					});
			});
