...
if ($_POST['save_plus']){
	...
	$plusdb->UpdateConfig('pk_last_raid_deactive', $_POST['pk_last_raid_deactive'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_last_raids_limit', $_POST['pk_last_raids_limit'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_set_lastraids_showloot', $_POST['pk_set_lastraids_showloot'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_set_lastraids_lootLimit', $_POST['pk_set_lastraids_lootLimit'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_ranking', $_POST['pk_ts_ranking'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_ranking_url', $_POST['pk_ts_ranking_url'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_ranking_link', $_POST['pk_ts_ranking_link'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_portal_thirdC', $_POST['pk_portal_thirdC'], $isplusconfarray);



	//Portal -> TS
	$plusdb->UpdateConfig('pk_ts_active', $_POST['pk_ts_active'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_title', $_POST['pk_ts_title'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_serverAddress', $_POST['pk_ts_serverAddress'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_serverQueryPort', $_POST['pk_ts_serverQueryPort'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_serverUDPPort', $_POST['pk_ts_serverUDPPort'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_serverPasswort', $_POST['pk_ts_serverPasswort'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_channelflags', $_POST['pk_ts_channelflags'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_userstatus', $_POST['pk_ts_userstatus'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_showchannel', $_POST['pk_ts_showchannel'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_showEmptychannel', $_POST['pk_ts_showEmptychannel'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_overlib_mouseover', $_POST['pk_ts_overlib_mouseover'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_joinable', $_POST['pk_ts_joinable'], $isplusconfarray);
	$plusdb->UpdateConfig('pk_ts_joinableMember', $_POST['pk_ts_joinableMember'], $isplusconfarray);
  ...
  if (($multi_result = $db->query($sql)))
   ...
   if (strtolower($eqdkp->config['default_game']) == 'wow')
   {
		...
		//Autocomplete
		$output .= "<script language='JavaScript' type='text/javascript' src='../pluskernel/include/jquery/js/jquery.dimensions.js'></script>";
		$output .= "<script language='JavaScript' type='text/javascript' src='../pluskernel/include/jquery/js/jquery.ui.autocomplete.js'></script>";
		$output .= "  <style>
		...
		foreach ($se as $value) $server_list .= '"'.$value.'",'	;
		foreach ($s as $value) $server_list .= '"'.$value.'",'	;
		$output .= ' <script>$(document).ready(function(){$("input.autocomplete").autocomplete({ list: ['.$server_list.']})});</script>';
   ...
   # Tab Portal
   #############
   $output .= $tabs->startTab('Portal', 'config2');
   $output .= $tabs->startTable();
   ...
   $output .= $tabs->tableheader('Portal |'.$plang['pk_thirdColumn']  );
   $output .= $html->CheckBox('pk_portal_thirdC', $plang['pk_set_thirdColumn'] , $conf['pk_portal_thirdC'], $plang['pk_help_thirdColumn']);
   $output .= '<tr><td></td></tr>';
   ...
   $output .= '<tr><td></td></tr>';
   $output .= $html->CheckBox('pk_last_raid_deactive', $plang['pk_set_lastraids'] , $conf['pk_last_raid_deactive'], $plang['pk_help_lastraid']);
   $output .= $html->TextField('pk_last_raids_limit', '2', intval($conf['pk_last_raids_limit']) ,$plang['pk_set_lastraids_limit'] , $plang['pk_help_lastraid_limit']);
   $output .= $html->CheckBox('pk_set_lastraids_showloot', $plang['pk_set_lastraids_showloot'] , $conf['pk_set_lastraids_showloot'], $plang['pk_help_lastraid_showloot']);
   $output .= $html->TextField('pk_set_lastraids_lootLimit', '2', intval($conf['pk_set_lastraids_lootLimit']) ,$plang['pk_set_lastraids_lootLimit'] , $plang['pk_help_lastraid_lootLimit']);
   $output .= '<tr><td></td></tr>';
   $output .= $html->CheckBox('pk_ts_ranking', $plang['pk_set_ts_ranking'] , $conf['pk_ts_ranking'], $plang['pk_help_ts_ranking']);
   $output .= $html->TextField('pk_ts_ranking_url', '30', $conf['pk_ts_ranking_url'] ,$plang['pk_set_ts_ranking_url'] , $plang['pk_help_ts_ranking_url']);
   $output .= $html->TextField('pk_ts_ranking_link', '30', $conf['pk_ts_ranking_link'] ,$plang['pk_set_ts_ranking_link'] , $plang['pk_help_ts_ranking_link']);

   $output .= $tabs->tableheader('TS-Viewer');
   $output .= $html->CheckBox('pk_ts_active', $plang['pk_set_ts_active'] , $conf['pk_ts_active'], $plang['pk_help_ts_active']);
   $output .= $html->TextField('pk_ts_title', '20', $conf['pk_ts_title'] ,$plang['pk_set_ts_title'] , $plang['pk_help_ts_title']);
   $output .= $html->TextField('pk_ts_serverAddress', '20', $conf['pk_ts_serverAddress'] ,$plang['pk_set_ts_serverAddress'] , $plang['pk_help_ts_serverAddress']);
   $output .= $html->TextField('pk_ts_serverQueryPort', '6', intval($conf['pk_ts_serverQueryPort']) ,$plang['pk_set_ts_serverQueryPort'] , $plang['pk_help_ts_serverQueryPort']);
   $output .= $html->TextField('pk_ts_serverUDPPort', '6', intval($conf['pk_ts_serverUDPPort']) ,$plang['pk_set_ts_serverUDPPort'] , $plang['pk_help_ts_serverUDPPort']);
   $output .= $html->TextField('pk_ts_serverPasswort', '10', $conf['pk_ts_serverPasswort'] ,$plang['pk_set_ts_serverPasswort'] , $plang['pk_help_ts_serverPasswort']);

   $output .= $html->CheckBox('pk_ts_channelflags', $plang['pk_set_ts_channelflags'] , $conf['pk_ts_channelflags'], $plang['pk_help_ts_channelflags']);
   $output .= $html->CheckBox('pk_ts_userstatus', $plang['pk_set_ts_userstatus'] , $conf['pk_ts_userstatus'], $plang['pk_help_ts_userstatus']);
   $output .= $html->CheckBox('pk_ts_showchannel', $plang['pk_set_ts_showchannel'] , $conf['pk_ts_showchannel'], $plang['pk_help_ts_showchannel']);
   $output .= $html->CheckBox('pk_ts_showEmptychannel', $plang['pk_set_ts_showEmptychannel'] , $conf['pk_ts_showEmptychannel'], $plang['pk_help_ts_showEmptychannel']);
   $output .= $html->CheckBox('pk_ts_overlib_mouseover', $plang['pk_set_ts_overlib_mouseover'] , $conf['pk_ts_overlib_mouseover'], $plang['pk_help_ts_overlib_mouseover']);
   $output .= $html->CheckBox('pk_ts_joinable', $plang['pk_set_ts_joinable'] , $conf['pk_ts_joinable'], $plang['pk_help_ts_joinable']);
   $output .= $html->CheckBox('pk_ts_joinableMember', $plang['pk_set_ts_joinableMember'] , $conf['pk_ts_joinableMember'], $plang['pk_help_ts_joinableMember']);
