...
if ($_POST['save_plus']){
  ...
  // global config
    $plusdb->UpdateConfig('pk_class_color', $_POST['pk_class_color'], $isplusconfarray); # Coloured Classnames?
		...
		$plusdb->UpdateConfig('pk_servername', $_POST['pk_servername'], $isplusconfarray);
...
// Global
   ...
   $output .= "<hr />"; 
   $output .= "<br />";   
   $output .= $html->TextField('pk_servername', '20', $conf['pk_servername'] ,$plang['pk_set_servername'] , $plang['pk_help_servername']);
