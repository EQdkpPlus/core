...
// Build the Dropdown Arrays:
		$itemstats_language = array(
			'german'							=> $lang['pk_german'],
			'english'							=> $lang['pk_english'],
			'french'							=> $lang['pk_french']
		);
...
// Output
	 $output  = ($data_saved == true) ? $html->MsgBox($lang['pk_save_title'], $lang['pk_succ_saved'], 'images/ok.png', '90%', true, '36px', '36px', true).'<br/>' : '';
	 $output .= $html->StartForm('settings', 'settings.php');
   $output .= $tabs->startPane('config');
   $output .= $tabs->startTab($lang['pk_tab_global'], 'config1');
// Global
   $output .= $html->CheckBox('pk_class_color', $lang['pk_set_ClassColor'] , $conf['pk_class_color'], $lang['pk_help_colorclassnames']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_quickdkp', $lang['pk_set_QuickDKP'] , $conf['pk_quickdkp'], $lang['pk_help_quickdkp']);
   $output .= "<br />";
   $output .= $html-> DropDown('pk_newsloot_limit', $newsloot_limit , $conf['pk_newsloot_limit'], $lang['pk_set_newsloot_limit'], $lang['pk_help_newsloot_limit'] );
   $output .= "<br />";
   $output .= "<hr />";
   $output .= $html->CheckBox('pk_updatecheck', $lang['pk_set_Updatecheck'] , $conf['pk_updatecheck'], $lang['pk_help_autowarning']);
   $output .= "<br />";   
   $output .= $html->TextField('pk_windowtime', '4', $conf['pk_windowtime'] ,$lang['pk_window_time1'] , $lang['pk_help_warningtime'])." ".$lang['pk_window_time2'];
   $output .= $tabs->endTab();
   $output .= $tabs->startTab($lang['pk_tab_multidkp'], 'config2');
// MultiDKP
   $output .= $html->CheckBox('pk_multidkp', $lang['pk_set_multidkp'] , $conf['pk_multidkp'], $lang['pk_help_multidkp']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_multiTooltip', $lang['pk_set_multi_Tooltip'] , $conf['pk_multiTooltip'],$lang['pk_help_dkptooltip']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_multiSmarttip', $lang['pk_set_multi_smartTooltip'] , $conf['pk_multiSmarttip'],$lang['pk_help_smarttooltip']);
   
   $output .= $tabs->endTab();
   $output .= $tabs->startTab($lang['pk_tab_links'], 'config3');
// Links
   $output .= $html->CheckBox('pk_links', $lang['pk_set_links'] , $conf['pk_links'], $lang['pk_help_links']);
   $output .= "<br /><br />";

   // the add Link thing
   $output .= "<table width='100%' border='0' cellspacing='1' cellpadding='2'>
  								<tr>
    								<th align='left'>".$lang['pk_set_linkname']."</th>
    								<th align='left'>".$lang['pk_set_linkurl']."</th>
    								<th align='left'>".$lang['pk_set_newwindow']."</th>
  								</tr>";
  ...
  $result = $db->query($sql);
   ...
   $output .= $tabs->endTab();
   $output .= $tabs->startTab($lang['pk_tab_bosscount'], 'config4');
// Bosscounter
   $output .= $html->CheckBox('pk_bosscount', $lang['pk_set_bosscounter'] , $conf['pk_bosscount'], $lang['pk_help_bosscounter']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_bossloot', $lang['pk_set_Bossloot'] , $conf['pk_bossloot'], $lang['pk_help_boosloot']);
   $output .= $tabs->endTab();
   $output .= $tabs->startTab($lang['pk_tab_listmemb'], 'config5');
// Listmembers
// 
   $output .= $html->CheckBox('pk_leaderboard', $lang['pk_set_leaderboard'] , $conf['pk_leaderboard'], $lang['pk_help_lm_leaderboard']);
   $output .= $html->CheckBox('pk_leaderboard_2row', $lang['pk_set_leaderboard_2row'] , $conf['pk_leaderboard_2row'], $lang['pk_help_leaderboard_2row']);
   $output .= $html->TextField('pk_leaderboard_limit', '2', $conf['pk_leaderboard_limit'], $lang['pk_set_leaderboard_limit'], $lang['pk_help_leaderboard_limit']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_rank', $lang['pk_set_rank'] , $conf['pk_rank'], $lang['pk_help_lm_rank']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_rank_icon', $lang['pk_set_rank_icon'] ,  $conf['pk_rank_icon'], $lang['pk_help_lm_rankicon']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_level', $lang['pk_set_level'] , $conf['pk_level'], $lang['pk_help_lm_level']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_lastloot', $lang['pk_set_lastloot'] , $conf['pk_lastloot'], $lang['pk_help_lm_lastloot']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_lastraid', $lang['pk_set_lastraid'] , $conf['pk_lastraid'], $lang['pk_help_lm_lastraid']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_attendance30', $lang['pk_set_attendance30'] , $conf['pk_attendance30'], $lang['pk_help_lm_atten30']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_attendance60', $lang['pk_set_attendance60'] , $conf['pk_attendance60'], $lang['pk_help_lm_atten60']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_attendance90', $lang['pk_set_attendance90'] , $conf['pk_attendance90'], $lang['pk_help_lm_atten90']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_attendanceAll', $lang['pk_set_attendanceAll'] , $conf['pk_attendanceAll'], $lang['pk_help_lm_attenall']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_showclasscolumn', $lang['pk_set_showclasscolumn'] , $conf['pk_showclasscolumn'], $lang['pk_help_showclasscolumn']);
   $output .= "<br />";
   $output .= "<br />";
   ...
   if ($pm->check(PLUGIN_INSTALLED, 'charmanager')) 
	 { 
	   ...
	   $output .= "<br />";
	   $output .= $html->CheckBox('pk_show_skill', $lang['pk_set_show_skill'] , $conf['pk_show_skill'], $lang['pk_help_show_skill']);
	   $output .= "<br />";
	   $output .= $html->CheckBox('pk_show_arkan_resi', $lang['pk_set_show_arkan_resi'] , $conf['pk_show_arkan_resi'], $lang['pk_help_show_arkan_resi']);
	   $output .= "<br />";
	   $output .= $html->CheckBox('pk_show_fire_resi', $lang['pk_set_show_fire_resi'] , $conf['pk_show_fire_resi'], $lang['pk_help_show_fire_resi']);
	   $output .= "<br />";
	   $output .= $html->CheckBox('pk_show_nature_resi', $lang['pk_set_show_nature_resi'] , $conf['pk_show_nature_resi'], $lang['pk_help_show_nature_resi']);
	   $output .= "<br />";
	   $output .= $html->CheckBox('pk_show_ice_resi', $lang['pk_set_show_ice_resi'] , $conf['pk_show_ice_resi'], $lang['pk_help_show_ice_resi']);
	   $output .= "<br />";
	   $output .= $html->CheckBox('pk_show_shadow_resi', $lang['pk_set_show_shadow_resi'] , $conf['pk_show_shadow_resi'], $lang['pk_help_show_shadow_resi']);
	   $output .= "<br />";
	   $output .= $html->CheckBox('pk_show_profiles', $lang['pk_set_show_profils'] , $conf['pk_show_profiles'], $lang['pk_help_show_profils']);
	   $output .= "<br />";	   
	 }  
   
   
   $output .= $tabs->endTab();
   $output .= $tabs->startTab($lang['pk_tab_itemstats'], 'config6');
// Itemstats
   $output .= $html->CheckBox('pk_itemstats', $lang['pk_set_itemstats'] , $conf['pk_itemstats'], $lang['pk_help_itemstats_on']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_itemstats_debug', $lang['pk_set_itemstats_debug'] , $conf['pk_itemstats_debug'], $lang['pk_help_itemstats_debug']);
   $output .= "<br />";   
   $output .= $html-> DropDown('pk_is_language', $itemstats_language , $conf['pk_is_language'], $lang['pk_is_language'], $lang['pk_help_itemstats_search']);
   $output .= "<br />";
   $output .= $html->TextField('pk_is_icon_ext', '10', $conf['pk_is_icon_ext'], $lang['pk_set_icon_ext'], $lang['pk_help_itemstats_icon_ext']);
   $output .= "<br />";
   $output .= $html->TextField('pk_is_icon_loc', '40', $conf['pk_is_icon_loc'], $lang['pk_set_icon_loc'], $lang['pk_help_itemstats_icon_url']);
   $output .= "<br />";
   $output .= $html->CheckBox('pk_trans_en_de', $lang['pk_set_en_de'] , $conf['pk_trans_en_de'], $lang['pk_help_itemstats_translate_deeng']);
   $output .= "<br />";
	 $output .= $html->CheckBox('pk_trans_de_en', $lang['pk_set_de_en'] , $conf['pk_trans_de_en'], $lang['pk_help_itemstats_translate_engde']);
   $output .= $tabs->endTab();
   $output .= $tabs->endPane();
   $output .= "<br />";
   $output .= "<div align='center'>";
   $output .= $html->Button('save_plus', $lang['pk_save']);
   $output .= "</div>";
   $output .= $html->EndForm();
   echo $output;
?>