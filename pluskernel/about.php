  ...
  echo $tabs->startTab($plang['pk_tab_stuff'], 'ab_team');
   ...
   <table width="100%" border="0">
     <tr>
        ...
        <tr>
          <td><b>Stefan "Corgan" Knaak</b></td>
          <td>EQDKP Plus Project Founder, Developer, Homepage</td>
        ...
        <tr>
          <td><b>Simon "Wallenium" Wallman</b></td>
        ...
        <tr>
          ...
          <td>Graphics, Design and Homepage</td>
        </tr>
        <tr>
     ...
     <tr>
        ...
        <tr>
          ...
          Patrick Bruner ,Michael Bäsching, Thomas Luft , Holy, Onuris/Dante,Adam Chachaj, Jochen Rähl,
          Kevin Keils,Andre Melsbach, Miora Thetin,Sirflippi, CG66,  Martin Widemann,Pelzer-Iggy, Kalliope,
          Maximilian Knop,Bernhard Gronau, Sven S, Sven Samoray, Chavez/Martin, Tobias Wirth,
          phaces, anaj, Kevin Keils, Klaus Damschen, Martin Kratsch, Alexander Drees, Mike W., Thorge Schlänä,
          Rondirai, Vampy, Flip, The Unknown, Claudi, Aoshi, Frank Schulzf, Markus Jessenitschnig, bennY aka Ferrus,
          Alex Ax, Tim Kleinholz, Black, Henri Brumme, sector23, Achaz, Mirco Reimer, Sascha Böttner, Hycron,
          Stefan von der Forst,Robert Böck,Monique Haring,Christian Sell,Sylvio Richter, DDLM Admin, Stefan Dieter,
          Patrick Kebekus,Jean-Marc licht,Thomas Glatte,Frank Prior, Nico F, Lucas Brandstätter, SeRoX,
          Leara, Manuela(cattiebrie), Lowmow, AGP-gilde,Blackhands United, uvm.  </td>
        </tr>
			</table>
   ';
