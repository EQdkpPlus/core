   ...
   echo '   <table width="100%" border="0">
     <tr>
        ...
        <tr>
          ...
          <td>'.EQDKPPLUS_VERSION.'</td>
          <td><a href="mailto:wallenium@eqdkp-plus.com">Wallenium</a></td>
          <td><a href="http://kompsoft.de/" target="_blank">http://kompsoft.de/</a></td>
        </tr>
				</table>';
   echo ' <br/>';
   echo ' <br/>';
  ...
  echo $tabs->startTab($plang['pk_tab_stuff'], 'ab_team');
   ...
   <table width="100%" border="0">
     <tr>
        ...
        <tr>
          <td><b>sz3</b></td>
          <td>Plugin Developer (Bosssuite)</td>
          <td></td>
        </tr>
        <tr>
          <td><b>Achaz</b></td>
          <td>Plugin Developer (Ticket, Attunement, Tradeskills )</td>
          <td></td>
        </tr>
        <tr>
     ...
     <tr>
        ...
        <tr>
          <td>Henri,Denis Christ,Martin J�cke, Robin Schmidt, Stephan Stenz, Snipes,Christian Wiegel,
          Patrick Bruner ,Michael B�sching, Thomas Luft , Holy, Onuris/Dante,Adam Chachaj, Jochen R�hl,
          Kevin Keils,Andre Melsbach, Miora Thetin,Sirflippi, CG66,  Martin Widemann,Pelzer-Iggy, Kalliope,
          Jochen R�hl, Maximilian Knop,Bernhard Gronau, Sven S, Sven Samoray, Chavez/Martin, Tobias Wirth,
          phaces, anaj, Kevin Keils, Klaus Damschen, Martin Kratsch, Alexander Drees, Mike W., Thorge Schl�n�,
          Rondirai, Vampy, Flip, The Unknown, Claudi, Aoshi, Frank Schulzf, Markus Jessenitschnig, bennY aka Ferrus,
          Alex Ax, Tim Kleinholz, Black, Henri Brumme, sector23, Achaz, Mirco Reimer, Sascha B�ttner, Hycron,
          Stefan von der Forst,Robert B�ck,Monique Haring,Christian Sell,Sylvio Richter, DDLM Admin, Stefan Dieter,
          Patrick Kebekus,Jean-Marc licht,Thomas Glatte,Frank Prior, Nico F, Lucas Brandst�tter, Thorge Schl�n�,
          SeRoX, Leara, Manuela(cattiebrie), Lowmow, AGP-gilde,Thorge Schl�n�, Blackhands United  </td>
        </tr>
			</table>
   ';
