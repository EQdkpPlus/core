...
<ul class='intro_message'>
  <table border='0' cellpadding='0' cellspacing='0' class='borderless' width='590'>
    <tr>
      ...
      ".$lang['pk_version']." ".$update->PlusVersion()."</td>
		...
		<table border='0' width='100%' id='table1' cellspacing='0' cellpadding='0' class='borderless'>
			<tr>
				...
				<table border='0' width='100%' id='table2' cellspacing='1' class='borderless'>
					...
					<tr>
						<td>".$lang['web_url'].": <a class='linkcrap' href='".$author['web_url']."' target='_blank'>".$author['web_name']."</a></td>
					</tr>
					<tr>
						<td>".$lang['personal_url'].": <a class='linkcrap' href='".$author['personal_url']."' target='_blank'>".$author['personal_name']."</a> 
						</td>						
					</tr>
					<tr>
   ...
   echo $tabs->startTab($lang['pk_credits'], 'about1');
 ...
 <br/>';
   ...
   echo $tabs->startTab($lang['pk_plugins'], 'about3');   
   ...
   echo $tabs->endTab();
   echo $tabs->startTab($lang['pk_modifications'], 'about2');   
   echo '
       <table width="100%" border="0">
    <tr> 
   ...
   ';
   echo $tabs->endTab();
   echo $tabs->startTab($lang['pk_themes'], 'about2');   
   echo '
   <table width="100%" border="0"> 
     <tr>
   ...
   ';
   echo $tabs->endTab();
   echo $tabs->startTab($lang['pk_sponsors'], 'about2');   
   echo '
   <table width="100%" border="0"> 
     <tr>
   ...
   ';
   echo $tabs->endTab();  
  echo $tabs->startTab($lang['pk_tab_stuff'], 'about2');   
   echo '
   <table width="100%" border="0"> 
     <tr>
          <td bgcolor="#CCCCCC"><strong>Name</strong></td>
   ...
   echo $tabs->endTab();
  echo $tabs->startTab($lang['pk_tab_help'], 'about2');   
   echo '
   <table width="100%" border="0"> 
     <tr>
