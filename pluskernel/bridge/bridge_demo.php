 ...
 * bridge_demo.php
 *
 *  $Id: bridge_demo.php 40 2007-07-06 15:40:27Z knaak $
 *****************************
 */
...
print_a($bridge->get_last_group_items(10));
...
#$bridge->new_user(1, 'corgan', md5('admin'), 'corgan@seniosdfs.de');
