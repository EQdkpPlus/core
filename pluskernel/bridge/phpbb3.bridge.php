...
function login($username, $password, $auto_login)
   {
            ...
            if ( $rut_row = $db_cms->fetch_record($remote_users_table) )
            {
                ...
                if ( $this->phpbb_check_hash($password,$rut_row['user_password'])  && $rgt_row['user_pending'] == "0") // Gucken ob das eingegebene Paswort mit dem CMS passwort übereinstimmt  und ob er berechtigt ist zuzugreifen
                {
