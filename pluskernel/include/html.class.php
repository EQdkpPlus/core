	...
	function ToolTip($tooltip_content, $normaltext)
	{
		...
		if($conf_plus['pk_multiTooltip'] == 1 and strlen($tooltip_content) > 0)
   	{
   		...
   		$tt= "<table cellpadding='0' border='0' class='borderless'>
 					...
 					#$tt = "<table cellpadding='0' border='0' class='borderless'><tr><td>sdfsdf sdfsd sdf sdf sd </td></tr></table>";
					$tt = str_replace(array("\n", "\r"), '', $tt);
 					...
 					#<a href="javascript:void(0);" onmouseover="return overlib(').', STICKY, MOUSEOFF);" onmouseout="return nd();">here</a>
