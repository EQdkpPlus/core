...
class rss
{
	...
	function rss()
	{
		...
		$this->rssurl = 'http://www.allvatar.com/news/index.php?p=rss&g='.$rss_number;
	...
	function createTPLvar($news)
	{
		...
		if (is_array($news))
		{
			...
			#$newsticker_V .= '<tr><td align=center>powered by <a href=http://www.allvatar.com target=_blank><img src='.$eqdkp_root_path.'/images/a_banner_88x31.gif></a> </td></tr>';
			$newsticker_V .= '</table>';
