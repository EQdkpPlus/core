	...
	function UpdateConfig($fieldname,$insertvalue, $confarray = false)
      {
        ...
        if(!in_array($fieldname, $confarray)){
...
//			{ 
//				message_die('Could not obtain EQDKP Plus configuration data. SQL Query failed.', '', __FILE__, __LINE__, $sql); 
//			}
...
//			}
   ...
   function InitConfig()
   {
        ...
        {
            $sql = "DELETE FROM ".$table_prefix."plus_links WHERE link_id='".$link_id."'";
            $db->query($sql);
            ...
            if ( $link_name == '' )
            {
                ...
                $db->query("INSERT INTO ".$table_prefix."plus_links ".$query);
             }
        }
		}
}// end of class
