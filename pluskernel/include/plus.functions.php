...
function get_classNameImgListmembers($class)
{
	...
	if($game_icons['class'])
	{
		...
		if(file_exists($class_img))
	   	{
			$img= "<img width=18 height=18 src='".$class_img."' alt='".$class."_icon'>";
			$_return = "<a class=".get_classColorChecked($class)."  href='".$eqdkp->config['server_path']."listmembers.php?s=&filter=".$class."'>".$img."&nbsp;$class</a>";
	   	}
	}
...
function get_classNameImgViewmembers($name)
{
	...
	if($game_icons['class'])
	{
		...
		if(file_exists($class_img))
	   	{
			$img= "<img width=18 height=18 src='".$class_img."' alt='".$class."_icon'>";
			$_return = "<a class=".get_classColorChecked($class)." href='".$eqdkp_root_path."viewmember.php?s=&name=".$name."'>".$img."&nbsp;".$name."</a>";
	   	}
	}
	return($_return) ;
}
...
function showAllvatarWoW_Signatur($charname, $class)
{
	...
	global $conf_plus, $eqdkp, $html,$user;
