...
class wow_modelviewer
{
	...
	var	$hostFilesS = array(0=> "modelviewer_scale.swf?4", 1=> "modelviewer.swf?3");
	
	var	$host 	 	  = "http://static.wowhead.com/modelviewer/";
	var	$hostefile 	  = "modelviewer_scale.swf?4";
	...
	function wow_itemviewer($itemID)
	{
		...
		{ 
			$modelType = '16' ;
			$object ='<object id="head" width="300" height="300" 
					  type="application/x-shockwave-flash" 
					  data="'.$this->host.$this->hostefile.'"
