...
class wow_modelviewer
{
	...
	var $race 						= array('dummy','human','orc','dwarf','nightelf','scourge','tauren','gnome','troll','goblin','bloodelf','draenei','worgen') ;
	...
	{
		$this->race['22'] = 'worgen'; //WTF, why gave blizz the worge raceID 22?? fu
	}
