		...
		if ( (isset($user->data['user_id'])) && ($user->data['user_id'] != ANONYMOUS) && (!empty($user->data['user_lang'])) )
    {
		...
		$js = "<script language='JavaScript' type='text/javascript'><!--
						...
						function AboutPLUSDialog() {
							if (contentWin != null) {
								Dialog.alert('".$lang['pk_close_jswin1']." Credits ".$lang['pk_close_jswin2']."', {windowParameters:{ className: 'alphacube', width:200, height:130}}); 
							}else {
								contentWin = new Window('AboutPLUS', {className: 'alphacube',  title: '".$lang['pk_plus_about']."',
						...
						function Updates() {
							if (updatewin != null) {
								Dialog.alert('".$lang['pk_close_jswin1']." Updates ".$lang['pk_close_jswin2']."', {windowParameters:{ className: 'alphacube', width:200, height:130}}); 
							}else {
						...
						function Settings() {
							if (settingswin != null) {
								...
								settingswin = new Window('SettingsPLUS', {className: 'alphacube', title: '".$lang['pk_config_header']."',
