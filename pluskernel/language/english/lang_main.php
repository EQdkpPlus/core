...
$plang['pk_set_bridge_inline']				= 'Integration eures Forums in das EQDKP - ACHTUNG BETA !';
$plang['pk_help_bridge_inline']				= 'Wenn ihr hier eine URL eintragt, dann wird im Menu ein zusätzlicher Link angezeigt, welcher die angegebene Seite innerhalb des Eqdkps anzeigt. Dies geschieht über ein dynamisches Iframe. Das EQDKP Plus ist aber nicht verantworltich für das Aussehen bzw. das Verhalten der eingebundenen Seite innerhalb eines Iframs!';
...
$plang['pk_is_help']						= '<b>ACHTUNG Änderungen am Verhalten von Itemstats mit Eqdkp Plus 0.5!</b><br><br>
											  Wenn ihr von Eqdp Plus 0.4 auf 0.5 aktualisiert oder die Such-Priorität geändert habt, müsst ihr euren Itemcache refreshen!!<br>
...
$plang['pk_set_lastraids']					= 'Dont show last raids';
$plang['pk_help_lastraid']					= 'If active, the last raids doesnt shown in the Menu';

$plang['pk_set_lastraids_limit']			= 'Last Raids Limit';
$plang['pk_help_lastraid_limit']			= 'Last Raids Limit';

$plang['pk_set_lastraids_showloot']			= 'Show Items below the Last Raids';
$plang['pk_help_lastraid_showloot']			= 'Show Items below the Last Raids';

$plang['pk_set_lastraids_lootLimit']		= 'Limit the Items';
$plang['pk_help_lastraid_lootLimit']		= 'Limit the Items';
...
$plang['pk_help_ts_title']					= 'TS-Server Title';

$plang['pk_set_ts_serverAddress']			= 'TS-Server IP';
$plang['pk_help_ts_serverAddress']			= 'TS-Server IP';

$plang['pk_set_ts_serverQueryPort']			= 'Query Port';
$plang['pk_help_ts_serverQueryPort']		= 'Query Port';

$plang['pk_set_ts_serverUDPPort']			= 'UDP Port';
$plang['pk_help_ts_serverUDPPort']			= 'UDP Port';

$plang['pk_set_ts_serverPasswort']			= 'Server Passwort';
$plang['pk_help_ts_serverPasswort']			= 'Server Passwort';


$plang['pk_set_ts_channelflags']			= 'Show Channelflags (R,M,S,P etc.)';
$plang['pk_help_ts_channelflags']			= 'Show Channelflags (R,M,S,P etc.)';

$plang['pk_set_ts_userstatus']				= 'Show Userstatus (U,R,SA etc.)';
$plang['pk_help_ts_userstatus']				= 'Show Userstatus (U,R,SA etc.)';

$plang['pk_set_ts_showchannel']				= 'Show Channels? (0 = only Player)';
$plang['pk_help_ts_showchannel']			= 'Show Channels? (0 = only Player)';

$plang['pk_set_ts_showEmptychannel']		= 'Show empty Channels?';
$plang['pk_help_ts_showEmptychannel']		= 'Show empty Channels?';
...
$plang['pk_set_ts_ranking']					= 'Show Rank Image';
$plang['pk_help_ts_ranking']				= 'Show Rank Image';

$plang['pk_set_ts_ranking_url']				= 'Rankimage URL like <a href=http://www.wowjutsu.com/>WoWJutsu</a> or <a href=http://www.bosskillers.com/>Bosskillers</a> ';
$plang['pk_help_ts_ranking_url']			= 'Rankimage URL like <a href=http://www.wowjutsu.com/>WoWJutsu</a> or <a href=http://www.bosskillers.com/>Bosskillers</a> ';

$plang['pk_set_ts_ranking_link']			= 'Rankimage Link';
$plang['pk_help_ts_ranking_link']			= 'Rankimage Link';
