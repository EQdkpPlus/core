...
$plang['pk_is_useitemlist']				  = 'Use Itemlist';
$plang['pk_help_useitemlist'] 			  = 'Itemlist allows faster fetching of Item-IDs, but it must be fetched one time, which could take some time and maybe too long, depends on your host.';
...
$plang['lib_email_sender_email'] = 'Mail from (Address)';
$plang['lib_email_sender_name'] = 'From Name';
$plang['lib_email_sendmail_path'] = 'Sendmail-Path';
$plang['lib_email_method'] = 'Mailer';
$plang['lib_email_mail'] = 'PHP-Mail-Function';
$plang['lib_email_sendmail'] = 'Sendmail';
$plang['lib_email_smtp'] = 'SMTP-Server';
$plang['lib_email_settings'] = 'Send method settings';
$plang['lib_email_smtp_user'] = 'SMTP-User';
$plang['lib_email_smtp_password'] = 'SMTP-Password';
$plang['lib_email_smtp_host'] = 'SMTP-Host';
$plang['lib_email_smtp_auth'] = 'SMTP-Auth';

$plang['lib_recaptcha_okey'] = 'Public Key of reCAPTCHA';
$plang['lib_recaptcha_okey_help']	= 'Insert here the public Key of your Account on reCAPTCHA.net.';
$plang['lib_recaptcha_pkey'] = 'Private Key of reCAPTCHA';
$plang['lib_recaptcha_pkey_help']	= 'Insert here the private Key of your Account on reCAPTCHA.net.';
