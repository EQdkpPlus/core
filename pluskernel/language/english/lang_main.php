...
$plang['pk_is_help']						= ' WARNING Changes in behaviour of Itemstats since Eqdkp Plus 0.5! <br>
												When you upgraded from Eqdkp Plus 0.4 to 0.5 or changed the search-priority, you have to refresh your itemcache!! <br>
												Recommended priority is 1. Armory and 2. WoWHead or 1. Buffed and 2. Allakhazam <br>
												Mixing Armory/WoWHead and Buffed/Allakhazam is not possible, because the tooltips and icons are not compatible! <br>
												For refreshing the itemcache follow the link, then click the buttons "Clear Cache" and after that "Update Itemtable';
...
$plang['pk_set_modelviewer_default']	= 'Default Modelviewer';
 ...
 $plang['pk_air_img_resize_enable'] = 'Enable image resize';
...
$plang['pk_set_rss_chekurl'] = 'check RSS-URL bevor update';
 $plang['pk_help_rss_chekurl'] = 'Controls whether or not the RSS-URL checkt before update.';
