 ...
 * (c) 2006 by WalleniuM [Simon Wallmann] & Stefan 'Corgan' Knaak
 * http://www.kompsoft.de & http://eqdkp-plus.com
 * ------------------
 * $Id:$
 ******************************/
...
$plang['pk_set_default_multi']		= 'Standart Konto für Leaderboard';
...
$plang['pk_help_round_precision']	= 'Bestimmt auf welche Nachkommastelle die DKP Anzeige bei der Ausgabe gerundet werden soll. Standart=0';
...
$plang['pk_is_set_lang']		= 'Standartsprache der Item ID´s.';
$plang['pk_is_help_lang']		= 'Standartsprache der Item IDs. Example : [item]17182[/item] will choose this language';
...
$plang['pk_is_help_patch_cache']	= 'Pfad für den Cache der eigenen Items, ausgehen von /itemstats/. Standart=./xml_cache/';
