...
$plang['pk_is_useitemlist']				  = 'Itemliste verwenden';
$plang['pk_help_useitemlist'] 			  = 'Über die Itemliste können Item-IDs schneller geholt werden, aber sie muss einmal geladen werden, was unter Umständen zu lange für den Host dauert.';
...
$plang['pk_set_libraries_tab']	= 'Libraries';
...
$plang['pk_set_links_tab_head']	= 'Links';
$plang['pk_set_leaderboard_tab_head']	= 'Leaderboard';
$plang['pk_set_listmembers_tab_head']	= 'Listmembers';
$plang['pk_set_cmplugin_tab_head']	= 'Charmanager Plugin';
$plang['pk_set_itemstats_tab_head']	= 'Itemstats';
$plang['pk_set_updates_tab_head']	= 'Update';
$plang['pk_set_bridgeconfig_tab_head']	= 'Bridge Einstellungen';
$plang['pk_set_email_header'] = "E-Mail";
$plang['pk_set_recaptcha_header'] = "ReCaptcha";

$plang['lib_email_sender_email'] = 'Mail von (Adresse)';
$plang['lib_email_sender_name'] = 'Von Name';
$plang['lib_email_sendmail_path'] = 'Sendmail-Pfad';
$plang['lib_email_method'] = 'Mailer';
$plang['lib_email_mail'] = 'PHP-Mail-Funktion';
$plang['lib_email_sendmail'] = 'Sendmail';
$plang['lib_email_smtp'] = 'SMTP-Server';
$plang['lib_email_settings'] = 'Einstellungen der Versandmethode';
$plang['lib_email_smtp_user'] = 'SMTP-Benutzer';
$plang['lib_email_smtp_password'] = 'SMTP-Passwort';
$plang['lib_email_smtp_host'] = 'SMTP-Host';
$plang['lib_email_smtp_auth'] = 'SMTP-Authentifizierung';

$plang['lib_recaptcha_okey'] = 'Öffentlicher Key von reCAPTCHA';
$plang['lib_recaptcha_okey_help']	= 'Trage hier den öffentlichen Key deines Account auf reCAPTCHA.net ein.';
$plang['lib_recaptcha_pkey'] = 'Privater Key von reCAPTCHA';
$plang['lib_recaptcha_pkey_help']	= 'Trage hier den privaten Key deines Account auf reCAPTCHA.net ein.';

$plang['pk_itemstats_max_execution_time'] = 'Sekunden als maximale Ausführungszeit für ItemStats';
$plang['pk_itemstats_max_execution_time_explain'] = 'Setze eine maximale Zeit, die ItemStats zur Verfügung steht. Dies kann sowohl fatalen Fehlern durch die Überschreitung der maximalen php Ausführungszeit vorbeugen, als auch die Seitenladenzeiten begrenzen. Items, die nach der Zeit dekoriert werden sollten, werden als normaler Text dargestellt. Der Wert 0 entspricht 80% der maximalen php Ausführungszeit.';
  //'rp_phpini_value'                 => 'php.ini Wert',
  //'rp_phpini_novalue'               => 'kein Wert',

$plang['pk_externals_tab']	= 'Export';
$plang['pk_externals_th']	= 'Export Einstellungen';
$plang['pk_externals_news']	= 'Export der News verhindern';
$plang['pk_externals_items']	= 'Export der Items verhindern';
$plang['pk_externals_raids']	= 'Export der Raids verhindern';
$plang['pk_externals_members']	= 'Export der Member verhindern';
