...
$plang['pk_set_bridge_dectivate_eq_reg']	= 'Registrierung im Eqdkp Plus auf die URL umlenken die als Foren URL angegeben ist.';
$plang['pk_help_bridge_dectivate_eq_reg']	= 'Wenn aktiviert, können sich keine User mehr direkt am Eqdkp Plus registrieren, sondern werden weitergeleitet auf die URL die unter Forum eingetragen ist.';
...
$plang['pk_help_dis_3dmember']				= 'Wenn deaktiviert, dann wird kein 3D Flash Model des WoW Chars angezeigt.';

$plang['pk_set_dis_3ditem']					= '3D Modelviewer für die Items abschalten';
$plang['pk_help_dis_3item']					= 'Wenn deaktiviert, dann wird kein 3D Flash Item-Model.';

$plang['pk_set_disregister']				= 'Die Registrierung am EQdkp komplett deaktivieren.';
$plang['pk_help_disregister']				= 'Wenn deaktiviert, dann können sich keine Member mehr am EQdkp registrieren. (anmelden funktioniert weiterhin)';
...
$plang['portalplugin_order']        = 'Reihenfolge';
