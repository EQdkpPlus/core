...
class pages extends page_generic {
	public static function __shortcuts() {
		$shortcuts = array('user','tpl', 'in', 'pdh', 'jquery', 'db', 'config', 'core', 'time', 'pm', 'bbcode'	=> 'bbcode', 'comments'	=> 'comments');
	...
	public function display(){
		...
		$content = $this->pm->do_hooks('pages_parse', array('text' => $content), 'text');
		$myRatings = array(
			'1'		=> '1',
			'2'		=> '2',
			'3'		=> '3',
