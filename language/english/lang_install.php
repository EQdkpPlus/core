...
$lang = array(
	...
	"file_permissions" => 'File- and Folderpermissions',
...
<li>to license your application under another license than the AGPL</li>
	...
	'module_ziparchive'		=> 'ZipArchive PHP module',
	...
	"ftp_info" => 'Instead of setting required file- and folderpermissions, you can use an ftp account to perform file interactions on the server. To use this optional setting please provide a ftp user with permissions to access your installation, and select the \'FTP Mode\' tick box. If you are not using FTP Mode you may simply select proceed on this page.',
	...
	'fp_data_folder'		=> 'Folder "data" exists and is writable',
	'fp_config_file'		=> 'File "config.php" exists and is writable',
	'fp_test_file' 			=> 'Testfile written and available',
