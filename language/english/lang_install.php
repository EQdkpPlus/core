...
'templatecache_ok'          => 'The templates cache directory ahs been set to be writeable in order to let the Templating engine create cached
...
'insterror_prefix'          => 'The Database Prefix already exists. Please go back and use another one or your data will be flushed!',
...
'inst_sql_error'            => 'Error! Failed to execute this SQL Statement: <br><br><ul>%s</ul> <br>',
