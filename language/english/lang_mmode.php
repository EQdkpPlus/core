...
"mmode_info" => "Your system is currently in maintenance mode, restricting normal user access. User can login again when you disable the maintenance mode.",
...
"no_nec_tasks" => "There are no necessary Updates.",
...
"stepend_info" => "The task is finished, but your system is still in maintenance mode so you can test eveything. User can login again when you disable the maintenance mode.",
"fix" => "Fix",
"update" => "Update",
"import" => "Import",
