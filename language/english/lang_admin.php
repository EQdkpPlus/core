...
$lang['puc_perform_intro']          = 'Following Plugins needs an update of the database structure. Please click on the "solve" Link to perform the Database changes for each plugin.<br/>Following Database tables are out of date:';
