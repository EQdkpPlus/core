...
"action_indivadjofraid_deleted" => "Individual adjustments deleted.",
...
"background_image" => "Background image ( 1000x1000px) [optional]",
...
"plugin_upload_error2" => "Only files of the type %s are allowed to be uploaded.",
...
"login_fb_appid_help" => "Enter the application number of your facebook application here.",
...
"bridge_samedb_help" => "Is the CMS/Forum in an other database?",
...
"repo_step1_error" => "Could not found a package for this extension. This can have several issues:<ul><li>The repository of EQdkp Plus is not reachable at the moment</li><li>Your server has been blacklisted. Contact the EQdkp Plus Team for further information.</li></ul>You can download the extension from <a href='".EQDKP_DOWNLOADS_URL."'>".EQDKP_DOWNLOADS_URL."</a>.",
