...
$lang = array( 
	...
	"core_sett_f_help_disclaimer_name" => 'Name of the person administrating this page. Important for imprint.',
	"core_sett_f_disclaimer_email" => 'E-mail address of the contact person',
	"core_sett_f_help_disclaimer_email" => 'Email of the person administration this page. It\'s recommended using an extra e-mail address.',
	"core_sett_f_disclaimer_irc" => 'IRC Channel',
	"core_sett_f_help_disclaimer_irc" => 'The IRC Channel of your guild, for further contacts',
	"core_sett_f_disclaimer_messenger" => 'Messenger, e.g. Skype, ICQ',
	"core_sett_f_help_disclaimer_messenger" => 'Name of the Messenger, e.g. Skype, ICQ, for further contacts',
	"core_sett_f_disclaimer_custom" => 'More information',
	"core_sett_f_help_disclaimer_custom" => 'More information displayed in the imprint',
	"core_sett_f_disclaimer_show" => 'Show imprint',
	"core_sett_f_help_disclaimer_show" => 'A link to the imprint will be displayed above the copyright.',
	"core_sett_f_disclaimer_address" => 'Address of the contact person ',
	"core_sett_f_help_disclaimer_address" => 'Postal address of contact person, required by law in some countries in the imprint.',
	...
	"core_sett_f_help_disable_username_change" => 'The users are not allowed to change their username themselves.',
	...
	"core_sett_f_help_calendar_raid_shownotes" => 'Show signin notes only to selected user groups, p.e. Administrators only',
	...
	"core_sett_f_help_sms_username" => 'The username of the allvatar.com SMS account. Other providers are currently not supported.',
	"core_sett_f_sms_password" => 'Password',
	"core_sett_f_help_sms_password" => 'The password of the allvatar.com SMS account.',
	"core_sett_f_sms_enable" => 'Turn on SMS functions',
	"core_sett_f_help_sms_enable" => 'Activate the SMS functions of EQDKP-Plus. This will allow confirmations and other items to be sent via SMS to users.',
	...
	"core_sett_f_help_disable_registration" => 'No new users can register themselves',
	...
	"cmsbridge_sso_cookiepath" => 'Cookie-path of the CMS/Forum',
	...
	"core_sett_f_disable_points" => 'Deactivate points',
