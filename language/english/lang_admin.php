...
$lang = array( 
	...
	"core_sett_fs_disclaimer" => 'Imprint',
	"core_sett_f_disclaimer_name" => 'Name of the contact person',
	"core_sett_f_core_sett_f_help_disclaimer_name" => 'Name of the person administrating this page. Important for imprint.',
	"core_sett_f_disclaimer_email" => 'E-mail address of the contact person',
	"core_sett_f_core_sett_f_help_disclaimer_email" => 'Email of the person administration this page. It\'s recommended using an extra e-mail address.',
	"core_sett_f_disclaimer_irc" => 'IRC Channel',
	"core_sett_f_core_sett_f_help_disclaimer_irc" => 'The IRC Channel of your guild, for further contacts',
	"core_sett_f_disclaimer_messenger" => 'Messenger, e.g. Skype, ICQ',
	"core_sett_f_core_sett_f_help_disclaimer_messenger" => 'Name of the Messenger, e.g. Skype, ICQ, for further contacts',
	"core_sett_f_disclaimer_custom" => 'More information',
	"core_sett_f_core_sett_f_help_disclaimer_custom" => 'More information displayed in the imprint',
	"core_sett_f_disclaimer_show" => 'Show imprint',
	"core_sett_f_core_sett_f_help_disclaimer_show" => 'A link to the imprint will be displayed above the copyright.',
	"core_sett_f_disclaimer_address" => 'Address of the contact person ',
	"core_sett_f_core_sett_f_help_disclaimer_address" => 'Postal address of contact person, required by law in some countries in the imprint.',
	"pk_contact_owner" => 'Owner infos:',
	"core_sett_fs_meta" => 'Meta-Information',
	"core_sett_f_meta_keywords" => 'Meta-Keywords',
	"core_sett_f_core_sett_f_help_meta_keywords" => 'Keywords are used for search engine optimazation.',
	"core_sett_f_meta_description" => 'Meta-Description',
	"core_sett_f_core_sett_f_help_meta_description" => 'Description used for search engine optimazation.',
	...
	"core_sett_f_disable_username_change" => 'Users may not change their accountname',
	"core_sett_f_core_sett_f_help_disable_username_change" => 'The users are not allowed to change their username themselves.',
	...
	"lib_pupd_core_intro2" => 'A new version of EQDKP Plus was found. Please download the new version from https://sourceforge.net/projects/eqdkp-plus/files/',
	...
	"core_sett_f_core_sett_f_help_calendar_raid_guests" => 'Guests can sign in for a raid, without receiving point.',
	"core_sett_f_calendar_raid_random" => 'Enable Random value',
	"core_sett_f_core_sett_f_help_calendar_raid_random" => 'This option shows the randomly created value on raid sign in.',
	"core_sett_f_date_startday" => 'First day of the week',
	"core_sett_f_core_sett_f_help_date_startday" => 'Set up, which day to show first in calendar',
	"core_sett_f_calendar_raid_classbreak" => 'Activate line break after x classes',
	"core_sett_f_core_sett_f_help_calendar_raid_classbreak" => 'If you are using a game with many classes, e.g. Everquest2, this line break prevents the page from being too wide.',
	"core_sett_f_calendar_raid_status" => 'Which raidstati shall be used?',
	"core_sett_f_core_sett_f_help_calendar_raid_status" => 'The different raidstatus elements in the raid-view in calendar. There should be at least two activated.',
	"core_sett_f_calendar_raid_nsfilter" => 'Which characters to show, except mains, at the \'not signed-in window\'.',
	"core_sett_f_core_sett_f_help_calendar_raid_nsfilter" => 'You can select, which characters should be visible in the list of unsigned characters.',
	...
	"core_sett_f_core_sett_f_help_calendar_addraid_deadline" => 'Set up the default time interval, in hours, between the start of the raid and the end of time for applications. Negative values = after raid start',
	"core_sett_f_calendar_addraid_use_def_start" => 'User defined time for raid start',
	"core_sett_f_core_sett_f_help_calendar_addraid_use_def_start" => 'On creation of new raids a user defined time should be used. If deselcted the current time is used.',
	"core_sett_f_calendar_addraid_def_starttime" => 'Default raid start time',
	"core_sett_f_core_sett_f_help_calendar_addraid_def_starttime" => 'The preselected start time for raids on raid creation.',
	"core_sett_f_calendar_addraid_duration" => 'Default duration of a raid',
	"core_sett_f_core_sett_f_help_calendar_addraid_duration" => 'Set up the default duration of a raid',
	"core_sett_f_calendar_addevent_mode" => 'Default pre-selection on event creation',
	"core_sett_f_core_sett_f_help_calendar_addevent_mode" => 'Select the default type for an event on raid creation, p.e. raid or event',
	"core_sett_f_calendar_show_birthday" => 'Show the birthdays of users in the calendar',
	"core_sett_f_core_sett_f_help_calendar_show_birthday" => 'Show the birthday of the users in the calendar. The birthday are only visible to users with the permission to see the user list.',
	"core_sett_f_calendar_raid_autoconfirm" => 'Automatic confirmation of selected user groups',
	"core_sett_f_core_sett_f_help_calendar_raid_autoconfirm" => 'Choose the user group to be confirmed automatically.If a user of that group signes in with a char, he will automatically be confirmed.',
	"core_sett_f_calendar_raid_autocaddchars" => 'Automatic signin of selected user groups on raid creation',
	"core_sett_f_core_sett_f_help_calendar_raid_autocaddchars" => 'Choose the user groups, which main char should automatically be added to new created raids. If the user owns no main char, he will not be signed in.',
	"core_sett_f_calendar_raid_shownotes" => 'Show sign in notes to selected user groups',
	"core_sett_f_core_sett_f_help_calendar_raid_shownotes" => 'Show signin notes only to selected user groups, p.e. Administrators only',
	"core_sett_f_calendar_raid_notsigned_classsort" => 'Sort unsigned chars by class names',
	"core_sett_f_core_sett_f_help_calendar_raid_notsigned_classsort" => 'Sort the unsigned characters by the name of their classes instead of alphabetically.',
	"core_sett_f_calendar_raid_coloredclassnames" => 'Show characters in class colours',
	"core_sett_f_core_sett_f_help_calendar_raid_coloredclassnames" => 'Colorize the characters with their class color',
	"core_sett_f_calendar_raid_shownotsigned" => 'Show unsigned Chars for all users',
	"core_sett_f_core_sett_f_help_calendar_raid_shownotsigned" => 'Should non enrolled characters be shown to all users? Operators and administrators will see them anyways. Only applies if the corresponding raid status are set.',
	"core_sett_f_calendar_raid_allowstatuschange" => 'Allow change of status after the registration deadline',
	"core_sett_f_core_sett_f_help_calendar_raid_allowstatuschange" => 'Allows users to change their status after the registration deadline has been reached',
	"core_sett_f_calendar_repeat_crondays" => 'How many days in the future should the raids be added to the database?',
	"core_sett_f_core_sett_f_help_calendar_repeat_crondays" => 'Please note: Higher values takes longer time to execute the crons.',
	"core_sett_f_calendar_email_statuschange" => 'Notification on signin status change',
	"core_sett_f_core_sett_f_help_calendar_email_statuschange" => 'Sends a notification to all raid attendees, if a raid leader changes the status of the application, p.e. "signed in" to "confirmed"',
	"core_sett_f_calendar_email_newraid" => 'Notification on raid creation',
	"core_sett_f_core_sett_f_help_calendar_email_newraid" => 'Sends a notification to all active users on creation of a new raid.',
	"core_sett_f_calendar_email_openclose" => 'Notification on opening/closing a raid',
	"core_sett_f_core_sett_f_help_calendar_email_openclose" => 'Sends a notification to all raid attendees, if a raid is closed or reopened.',
	...
	"core_sett_f_core_sett_f_help_class_color" => 'If activated, all characters are displayed in the color of their class and a class-icon is shown next to their name.',
	"core_sett_f_special_members" => 'Special characters',
	"core_sett_f_core_sett_f_help_special_members" => 'Special characters are \'bank\' or \'disenchanted\'. They are not shown on e.g. the points list.',
	"core_sett_f_special_user" => 'Special users',
	"core_sett_f_core_sett_f_help_special_user" => 'Special user are user like the maintenance user. They are not shown on e.g. the userlist.',
	"core_sett_f_detail_twink" => 'Detailed twink information',
	"core_sett_f_core_sett_f_help_detail_twink" => 'If activated, you can view a list of Twinks with their corresponding points for each character on the standings page.',
	"core_sett_f_hide_inactive" => 'Hide Inactive characters',
	"core_sett_f_core_sett_f_help_hide_inactive" => 'Hide characters, which did not attend on raids the last x days?',
	"core_sett_f_inactive_period" => 'Inactive Period',
	"core_sett_f_core_sett_f_help_inactive_period" => 'Amount of days, a character can be absent from raids and stay active. Insert 0 to disable inactivation.',
	"core_sett_fs_sms" => 'SMS settings',
	"core_sett_fs_info_sms" => 'To send SMS\' you need login credentials.',
	"sms_info_account_link" => '<a href="http://www.allvatar.com/index.php?p=sms" target="_blank">http://www.allvatar.com/index.php?p=sms</a>',
	"core_sett_f_sms_username" => 'Username',
	"core_sett_f_core_sett_f_help_sms_username" => 'The username of the allvatar.com SMS account. Other providers are currently not supported.',
	"core_sett_f_sms_password" => 'Password',
	"core_sett_f_core_sett_f_help_sms_password" => 'The password of the allvatar.com SMS account.',
	"core_sett_f_sms_enable" => 'Turn on SMS functions',
	"core_sett_f_core_sett_f_help_sms_enable" => 'Activate the SMS functions of EQDKP-Plus. This will allow confirmations and other items to be sent via SMS to users.',
	"core_sett_fs_game" => 'Game settings',
	"core_sett_fs_importer" => 'Importer settings',
	"core_sett_f_default_gamelang" => 'Language of the game',
	"core_sett_f_default_game" => 'Game',
	"core_sett_f_core_sett_f_help_default_game" => 'The game the guild using this website is playing.',
	"core_sett_f_default_gamelang_help" => 'The language of the selected game',
	...
	"core_sett_f_core_sett_f_help_default_style_overwrite" => 'The usersettings are overwritten with the settings from here.',
	"core_sett_f_enable_captcha" => 'Use an activationcode for registration',
	"core_sett_f_core_sett_f_help_enable_captcha" => 'Use CAPTCHA for registration',
	"core_sett_f_disable_registration" => 'Deactivate user registration',
	"core_sett_f_core_sett_f_help_disable_registration" => 'No new users can register themselves',
	"core_sett_f_account_activation" => 'Activate account activation',
	"core_sett_f_core_sett_f_help_account_activation" => 'Shall a new created account be activated, and how?',
	"core_sett_f_core_sett_f_help_default_lang" => 'Default language for guests and new registered users',
	...
	"core_sett_f_core_sett_f_help_failed_logins_inactivity" => 'If the number of failed logins is reached, the user account will be temporarily disabled and the user will an email with a re-activation link.',
	...
	"core_sett_f_core_sett_f_help_itemhistory_dia" => 'At the viewitem page a diagram is shown, which displays the development of the price. At the viewraid page a diagram shows the class distribution.',
	"core_sett_f_custom_logo" => 'Logo of the DKP-System',
	"core_sett_f_core_sett_f_help_custom_logo" => 'Here you can change the logo of your DKP-System',
	"core_sett_f_core_sett_f_help_default_alimit" => 'Number of adjustments per page.',
	"core_sett_f_core_sett_f_help_default_elimit" => 'Number of events per page.',
	"core_sett_f_core_sett_f_help_default_ilimit" => 'Number of items per page.',
	"core_sett_f_core_sett_f_help_default_nlimit" => 'Number of news per page.',
	"core_sett_f_core_sett_f_help_default_rlimit" => 'Number of raids per page.',
	...
	"core_sett_f_core_sett_f_help_timezone" => 'Select the default core_sett_f_timezone you want to have set for new registered users and guests.',
	"core_sett_f_core_sett_f_help_default_date_time" => 'The syntax is the same as used by the <a href="http://www.php.net/date" target="_blank">date()</a> function of PHP.',
	"core_sett_f_core_sett_f_help_default_date_short" => 'The syntax is the same as used by the <a href="http://www.php.net/date" target="_blank">date()</a> function of PHP.',
	"core_sett_f_core_sett_f_help_default_date_long" => 'The syntax is the same as used by the <a href="http://www.php.net/date" target="_blank">date()</a> function of PHP.',
	"core_sett_f_core_sett_f_help_default_jsdate_time" => 'Used by the javascript calendar. The syntax can be seen <a href="http://arshaw.com/fullcalendar/docs/utilities/formatDate/" target="_blank">here</a>.',
	"core_sett_f_core_sett_f_help_default_jsdate_nrml" => 'Used by the javascript calendar. The syntax can be seen <a href="http://arshaw.com/fullcalendar/docs/utilities/formatDate/" target="_blank">here</a>.',
	"core_sett_f_core_sett_f_help_default_jsdate_short" => 'Used by the javascript calendar. The syntax can be seen <a href="http://arshaw.com/fullcalendar/docs/utilities/formatDate/" target="_blank">here</a>.',
	"core_sett_f_default_locale" => 'Default Locale (character set only; does not affect language)',
	"core_sett_f_core_sett_f_help_default_locale" => 'Used character set, e.g. for translating months.',
	"core_sett_f_server_path" => 'Script path',
	"core_sett_f_core_sett_f_help_server_path" => 'Path to EQdkp,relative to the domain name',
	"core_sett_f_enable_gzip" => 'Enable Gzip Compression',
	"core_sett_f_core_sett_f_help_enable_gzip" => 'Comprimation reduces traffic, but can lead to some other problems.',
	...
	"core_sett_f_core_sett_f_help_cookie_path" => 'The path of the Cookie should only be edited by people, who know what it is for. If not entered properly the login may not work.',
	"core_sett_f_cookie_name" => 'Cookie Name',
	"core_sett_f_core_sett_f_help_cookie_name" => 'Name of the cookie. It should only be edited by people, who know what it is for. If not entered properly the login may not work',
	"core_sett_f_cookie_domain" => 'Cookie Domain',
	"core_sett_f_core_sett_f_help_cookie_domain" => 'The domain of the cookie should only be edited by people, who know what it is for. If not entered properly the login may not work.',
	"core_sett_f_session_length" => 'Session Length (seconds)',
	"core_sett_f_core_sett_f_help_session_length" => 'Length of session in seconds. Should not be too long (default: 3600).',
	"core_sett_f_auth_method" => 'Authentication method',
	"core_sett_f_core_sett_f_help_auth_method" => 'Set up, which module shall be used when users sign in.',
	"auth_db" => 'Database',
	"core_sett_f_login_method" => 'Login-Methods',
	"core_sett_f_core_sett_f_help_login_method" => 'Choose additinal modules for logging in your users.',
	...
	"core_sett_f_core_sett_f_help_disable_embedly" => 'Links to video/pictures (e.g. youtube) will be converted automatically to embedded objects',
	"core_sett_tab_global" => 'Global',
	"core_sett_fs_global" => 'Global',
	"core_sett_f_update_check" => 'Show an automatic warning for updates',
	"core_sett_f_core_sett_f_help_update_check" => 'Warns the administrator on login, if updates are available online.',
	"core_sett_f_guildtag" => 'Guildtag / Alliance Name',
	"core_sett_f_core_sett_f_help_guildtag" => 'Is used in the title of this Website and to fetch information from external databases (e.g. curse, battle.net).',
	"core_sett_f_debug" => 'EQDKP-PLUS Debug Mode enabled',
	"core_sett_f_core_sett_f_help_debug" => 'If activated, EQdkp-Plus is in Debug-Mode, which provides additional information and error messages.',
	"pk_set_core_sett_f_debug_type0" => 'Debug off (Debug=0)',
	"pk_set_core_sett_f_debug_type1" => 'Debug on simple (Debug=1)',
	"pk_set_core_sett_f_debug_type2" => 'Debug on with SQL Queries (Debug=2)',
	"pk_set_core_sett_f_debug_type3" => 'Debug on extended (Debug=3)',
	"pk_set_core_sett_f_debug_type4" => 'Developer Mode (Debug =4)',
	"core_sett_f_main_title" => 'Page name',
	"core_sett_f_core_sett_f_help_main_title" => 'Name of the page',
	"core_sett_f_sub_title" => 'Page description',
	"core_sett_f_core_sett_f_help_sub_title" => 'Description of the site.',
	"core_sett_f_dkp_name" => 'Point name',
	"core_sett_f_core_sett_f_help_dkp_name" => 'The short name for the points (p.e.DKP, RP, etc.)',
	"core_sett_f_color_items" => 'Threshold for numbers (negative, neutral, positive)',
	"core_sett_f_core_sett_f_help_color_items" => 'Set the thresholds for the coloring of numbers, e.g. for the raid attendance',
	"core_sett_f_round_activate" => 'Round Points on output, so only x decimal places are shown.',
	"core_sett_f_core_sett_f_help_round_activate" => 'If activated, points are rounded on output. Example: 125.55 becomes 126.6.',
	"core_sett_f_round_precision" => 'Decimal place to round to.',
	"core_sett_f_core_sett_f_help_round_precision" => 'Sets the decimal place on which to round points on output. Default: 0.',
	"core_sett_f_enable_comments" => 'Enable comments',
	"core_sett_f_core_sett_f_help_enable_comments" => 'Activates comments on all pages, which support comments. For some plugins the comments can be disabled separately. For news comments are always enabled.',
	"core_sett_tab_itemtooltip" => 'Itemtooltip',
	"core_sett_fs_itemtooltip" => 'ItemTooltip',
	"infotooltip_use" => 'Enable ItemTooltip',
	"itt_core_sett_f_debug" => 'Debug mode',
	"itt_core_sett_f_core_sett_f_help_debug" => 'Show extra information about how the information were fetched in the tooltip.',
	...
	"core_sett_f_core_sett_f_help_admin_email" => 'Valid address which shall be used for admin actions.',
	"core_sett_f_lib_email_sender_name" => 'Sender\'s name',
	"core_sett_f_core_sett_f_help_lib_email_sender_name" => 'Sender\'s name in emails',
	"core_sett_f_lib_email_sendmail_path" => 'Path to sendmail',
	"core_sett_f_core_sett_f_help_lib_email_sendmail_path" => 'The path to sendmail on your server. Have a look at your webhoster\'s FAQ if you don\'t know it.',
	"core_sett_f_lib_email_method" => 'Mailing method',
	"core_sett_f_core_sett_f_help_lib_email_method" => 'Choose an emailing method. Your server has to support this method.',
	...
	"core_sett_f_core_sett_f_help_lib_email_smtp_user" => 'The username of your SMTP account',
	"core_sett_f_lib_email_smtp_pw" => 'SMTP password',
	"core_sett_f_core_sett_f_help_lib_email_smtp_pw" => 'The password of the SMTP server',
	"core_sett_f_lib_email_smtp_host" => 'SMTP host',
	"core_sett_f_core_sett_f_help_lib_email_smtp_host" => 'Your SMTP server',
	"core_sett_f_lib_email_smtp_auth" => 'SMTP authentication',
	"core_sett_f_core_sett_f_help_lib_email_smtp_auth" => 'Does the SMTP server require authentication?',
	"core_sett_f_lib_email_signature" => 'Append signature',
	"core_sett_f_core_sett_f_help_lib_email_signature" => 'Should a signature be appended to the emails?',
	"lib_signature_defaultval" => 'Sent from EQdkp Plus',
	"core_sett_f_core_sett_f_lib_email_signature_value" => 'Signature',
	"core_sett_f_core_sett_f_core_sett_f_help_lib_email_signature_value" => 'The signature for the emails sent by EQdkp Plus.',
	"core_sett_f_lib_email_smtp_port" => 'SMTP Server-Port',
	"core_sett_f_core_sett_f_help_lib_email_smtp_port" => 'Only change this setting if you know your SMTP-Server is using another port. Default-port is 25.',
	"core_sett_f_lib_email_smtp_connmethod" => 'SMTP connection-method',
	"core_sett_f_core_sett_f_help_lib_email_smtp_connmethod" => 'Select the secure connection method your SMTP-Server is using',
	"core_sett_f_lib_recaptcha_okey" => 'Public key of reCaptcha',
	"core_sett_f_core_sett_f_help_lib_recaptcha_okey" => 'Insert the public key of your account at reCaptcha.net here.',
	"core_sett_f_lib_recaptcha_pkey" => 'Private key of reCaptcha',
	"core_sett_f_core_sett_f_help_lib_recaptcha_pkey" => 'Insert the private key of your account at reCaptcha.net here.',
	...
	"liveupdate_step1_error" => 'No packages has been found. Several reasons are possible: <ul><lil>The EQdkp-Plus update server is down atm </li><li>Your server was blacklisted. Please contact the EQdkp-Plus team</li><li>There is no update for your version</li></ul> You can always download updates or complete packages at <a href=\'https://sourceforge.net/projects/eqdkp-plus/files/\'>https://sourceforge.net/projects/eqdkp-plus/files/</a> and update your system manually',
	...
	"core_sett_f_core_sett_f_help_thumbnail_defaultsize" => 'Insert here the width (in Pixel) of the Thumbnails for large images',
	...
	"core_sett_f_core_sett_f_help_seo_remove_index" => 'To use this feature, you have to uncomment the SEO-Options and to adjust the server-path in the .htaccess-file.',
	...
	"core_sett_f_core_sett_f_help_mobile_template" => 'Show the selected template for all mobile devices',
	"core_sett_f_mobile_pagelayout" => 'Tablelayout for mobile devices',
	"core_sett_f_core_sett_f_help_mobile_pagelayout" => 'The selected Table- & Pointlayout will be shown for all mobile devices',
	"core_sett_f_mobile_portallayout" => 'Portallayout for mobile devices',
	"core_sett_f_core_sett_f_help_mobile_portallayout" => 'The selected Portallayout will be shown for all mobile devices',
