...
// Help lines
$lang['b_help'] = 'Bold text: [b]text[/b] (alt+b)';
$lang['i_help'] = 'Italic text: [i]text[/i] (alt+i)';
$lang['u_help'] = 'Underlined text: [u]text[/u] (alt+u)';
$lang['q_help'] = 'Quote text: [quote]text[/quote] (alt+q)';
$lang['c_help'] = 'Center text: [center]text[/center] (alt+c)';
$lang['p_help'] = 'Insert image: [img]http://image_url[/img] (alt+p)';
$lang['w_help'] = 'Insert URL: [url]http://url[/url] or [url=http://url]URL text[/url]  (alt+w)';
