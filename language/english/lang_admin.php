...
$lang = array(
	...
	"core_sett_f_help_calendar_raid_add_raidgroupchars" => 'Choose the raid groups, which main char should automatically be added to new created raids. If the user owns no main char, he will not be signed in.',
