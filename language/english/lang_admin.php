...
$lang = array( 
	...
	"calendar_show_birthday" => 'Show the birthdays of users in the calendar',
	"calendar_show_birthday_help" => 'Show the birthday of the users in the calendar. The birthday are only visible to users with the permission to see the user list.',
	...
	"pk_tab_fs_article" => 'Article settings',
	...
	"default_jsdate_time" => 'Javascript time format',
	"default_jsdate_nrml" => 'Javascript date format (normal)',
	"default_jsdate_short" => 'Javascript date format (short)',
	...
	"default_jsdate_time_help" => 'Used by the javascript calendar. The syntax can be seen <a href="http://arshaw.com/fullcalendar/docs/utilities/formatDate/" target="_blank">here</a>.',
	"default_jsdate_nrml_help" => 'Used by the javascript calendar. The syntax can be seen <a href="http://arshaw.com/fullcalendar/docs/utilities/formatDate/" target="_blank">here</a>.',
	"default_jsdate_short_help" => 'Used by the javascript calendar. The syntax can be seen <a href="http://arshaw.com/fullcalendar/docs/utilities/formatDate/" target="_blank">here</a>.',
	...
	"default" => 'Default',
	"rank_icon" => 'Rank-Icon',
	"pk_tab_fs_mobile" => 'Mobile devices',
	"mobile_template" => 'Template for mobile devices',
	"mobile_template_help" => 'Show the selected template for all mobile devices',
	"mobile_pagelayout" => 'Tablelayout for mobile devices',
	"mobile_pagelayout_help" => 'The selected Table- & Pointlayout will be shown for all mobile devices',
	"mobile_portallayout" => 'Portallayout for mobile devices',
	"mobile_portallayout_help" => 'The selected Portallayout will be shown for all mobile devices',
