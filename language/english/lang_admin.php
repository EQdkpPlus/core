...
"action_indivadjofevent_deleted" => "Individual adjustments of event deleted.",
...
"itempool_before" => "Itempool before",
"itempool_after" => "Itempool after",
"mainc" => "Mainchar",
...
"calendar_raid_shownotes_help" => "Show signin notes for selected user groups, p.e. Administrators only. If no group is selected, the notes will be hidden.",
