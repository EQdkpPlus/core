...
"step_8" => "Many have experienced it, no one liked it - system failure, data loss and backup absence<br /><br />This can't happen anymore!<br /><br />In addition to restoration from backups you now can set up automated backup jobs. Go to \"Cron-job management\" to set the options.<br /><br />If you'd like more information about backup check out <a href=\"".EQDKP_WIKI_URL."/de/index.php/Sicherung\" target=\"_blank\" style=\"color:#000;\">this Wiki page</a>.",
"step_8_title" => "Backup",
