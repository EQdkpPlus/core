...
$lang = array( 
	...
	"get_user_sett_f_new_password" => 'Get a New Password',
	"no_account" => 'Don\'t have an account?',
	"no_activation_mail" => 'Got no confirmation mail?',
	"get_new_activation_mail" => 'Resend confirmation mail',
	"create_user_sett_f_new_password" => 'Create new password',
	...
	"user_sett_f_user_sett_f_help_confirm_password" => 'You only need to confirm your new password if you changed it above',
	"user_sett_f_confirm_password_repeat_note" => 'Please reenter your password for security reasons.',
	"user_sett_f_current_password" => 'Current Password',
	"user_sett_f_current_password_note" => 'You must confirm your current password if you wish to change your username or password',
	"email" => 'Email',
	...
	"user_sett_f_new_password_note" => 'You only need to supply a new password if you want to change it',
	"password" => 'Password',
	...
	"more_plugins" => 'For more Plugins visit <a href=\'https://sourceforge.net/projects/eqdkp-plus/files/\'>https://sourceforge.net/projects/eqdkp-plus/files/</a>.',
	"more_moduls" => 'For more Modules visit <a href=\'https://sourceforge.net/projects/eqdkp-plus/files/\'>https://sourceforge.net/projects/eqdkp-plus/files/</a>.',
	"more_template" => 'For more Styles visit <a href=\'https://sourceforge.net/projects/eqdkp-plus/files/\'>https://sourceforge.net/projects/eqdkp-plus/files/</a>',
    ...
    "user_sett_fs_user_priv" => "Contact",
    "user_sett_fs_user_wall" => "Wall",
	"user_sett_f_first_name" => 'First name',
	"user_sett_f_last_name" => 'Last name',
	"user_sett_fs_profile" => 'Profile information',
	"user_sett_f_country" => 'Country',
	"user_sett_f_town" => 'Town',
	"user_sett_f_state" => 'State',
	"user_sett_f_ZIP_code" => 'ZIP Code',
	"user_sett_f_phone" => 'Phone number',
	"user_sett_f_cellphone" => 'Cell phone number',
	"user_sett_f_help_phone" => 'Phone numbers will be saved anonymously and only admins are able to see them. With the cell phone number given you can send each other text messages anonymously, e.g. in case of new raid events or cancelled raids.',
	"user_sett_f_help_cellphone" => 'The pricacy settings control the access to your mobile phone number. You can have text messages sent to your mobile phone anonymously e.g. if raids are created or cancelled.',
	"user_sett_f_icq" => 'ICQ number',
	"user_sett_f_skype" => 'Skype',
	...
	"user_sett_f_gender_m" => 'Male',
	"user_sett_f_gender_f" => 'Female',
	...
	"user_sett_f_send_new_pw_note" => 'Send a new and random password to the user',
	"user_sett_fs_misc" => 'Miscellaneous',
...
If you are a Facebook member and do not want Facebook to connect the data concerning your visit to our website with your member data already stored by Facebook, please log off Facebook before entering our website. Further you can block Facebook social Plugins by using add-ons for your browser, like the “Facebook Blocker“.',
	...
	"user_list" => 'Userlist',
	"user_priv" => 'Privacy',
	"user_sett_f_priv_set" => 'Contact data (e.g. email, Skype, ICQ) visible to',
	...
	"user_sett_f_priv_phone" => 'Telephone number visible to',
	"user_sett_f_priv_nosms" => '<b>Completely disable text reception through administrators.</b><br/>(No raid invitations can be texted to you)',
	...
	"age" => 'Age',
	"user_sett_f_work" => 'Occupation',
	"user_sett_f_hardware" => 'Hardware',
	"user_sett_f_interests" => 'Hobbies',
	...
	"raidevent_raid_val_addevent" => 'There is no capable calendar for adding events. Please add one <a target="_parent" href=".'.registry::get_const('server_path').'admin/manage_calendars.php">here</a>',
	...
	"user_sett_fs_auth_accounts_help" => 'Connect your user with your account at the given provider, using it to log into EQdkp Plus',
	...
	"user_sett_f_user_avatar_type_own" => "Own Avatar",
	"user_sett_f_user_avatar_type_gravatar" => "Gravatar",
	"user_sett_f_user_gravatar_mail" => "Gravatar Email-Address",
	"user_sett_f_user_sett_f_help_user_gravatar_mail" => "Insert here your Gravatar-Email-Address if it's not your registration Email-Address.",
	"user_avatar" => "Avatar",
