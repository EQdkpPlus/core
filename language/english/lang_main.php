...
"LANG_VERSION" => '2.3.20.0',
	...
	"user_sett_fs_calendar_awaymode_settings" => 'Away-Mode',
	"user_sett_f_awaymode_enabled" => "enable away-mode",
	"user_sett_f_help_awaymode_enabled" => "If the away mode is enabled, there won't be any new automatic raid-signins in this time frame and the chars will be marked in red.",
	...
	"user_sett_f_help_awaymode_startdate" => "The start date of the abscence",
	...
	"user_sett_f_help_awaymode_note" => "Write a short description why you are absent",
	...
	"calendar_eventlabel_open" => "Public",
	"calendar_eventlabel_private" => "Private",
	...
	"hptt_default_part_footcount" => '... %2$d entries found / %1$d are shown',
	...
	"fv_invalid_email_blocked" => 'It is not possible to register using this e-mail address.',
	...
	"fv_email_not_match" => 'The entered emailaddresses do not match.',
	...
	"fv_fields_not_match" => "The entered data does not match",
	...
	"tableentries_per_page" => 'Tableentries per Page',
	...
	"password_sent" => 'An email with instructions has been sent to you.',
	...
	"Multi_Accs" => 'Point accounts',
	"Multi_kontoname_short" => 'Accountname',
	"beta_warning" => 'Warning! This EQDKP-Plus Beta Version should not be used in a live environment! This Version stops working if a stable version is available. Check <a href="https://eqdkp-plus.eu" >https://eqdkp-plus.eu</a> for updates!',
	"comment" => 'Comment',
	"comments" => 'Comments',
	...
	"belonging_mdkppools" => 'Linked Point accounts',
	...
	"calendar_repeat_custom" => "custom",
	"calendar_log_repeat_0" => 'Single event',
	"calendar_log_repeat_7" => 'weekly',
	"calendar_log_repeat_1" => 'daily',
	"calendar_log_repeat_14" => 'two weeks',
	...
	"calendar_export_feed" => 'Link to the iCal feed for external programs, such as Outlook or iCal. This is a personal link including a secret hash. Do not share this link with other people.',
	"calendar_export_feedurl" => 'Feed URL',
	"calendar_export_dl_ical" => 'Download *.ics',
	"calendar_export_download" => 'Download Events',
	"calendar_eventdetails_invitations" => 'Invitations',
	"calendar_eventdetails_confirmations" => 'Confirmations',
	"calendar_eventdetails_maybes" => 'Maybe',
	"calendar_eventdetails_declines" => 'Declines',
	...
	"calendar_sharing_receipients_raidgroup" => 'Invite raidgroup',
	"calendar_event_private" => 'Private event',
	"calendar_raid_private" => 'Private raid',
	"raidevent_repeat_raid_text" => "The event will be repeated %1\$s",
	"raidevent_repeat_raid_days" => "%1\$s days",
	...
	"optgroup_templates" => "Templates",
	"optgroup_lastraids" => "Last added",
	...
	"raidevent_raid_note_mainchar" => 'Automatically added as mainchar',
	"raidevent_raid_note_attendance" => 'Automatically added based on attendance',
	"raidevent_raid_autosignoffnote" => "Automatically signed-off because of enabled away-mode",
	...
	"raidevent_dragdrop_movesuccessmsg" => "Attendee changes saved successfully.",
	"raidevent_dragdrop_moveerrormsg" => "An error occured while moving the attendee. Please try again.",
	...
	"home" => 'Home',
	"select_mdkppool" => 'Select Point account',
	...
	"password_too_short" => 'The password you entered is too short. Please use at least %s chars.',
	...
	"droprate" => 'Droprate',
	"error_saving_char" => 'An error occurred while saving this character. Character may already be in the system.',
	...
	"user_sett_fs_info_notifications" => 'Please note that you will only receive some notifications based on your permissions, even if you have subscribed to them.',
	...
	"user_sett_f_ntfy_eqdkp_calendar_guest_application" => 'Raid guests awaiting approval',
	...
	"user_sett_f_ntfy_eqdkp_user_new_registered" => "New Userregistration",
	...
	"notification_calendarevent_new" => "A new Calendarevent has been created: {ADDITIONAL}",
	"notification_calendarevent_invitation" => "{PRIMARY} has invited you to a calendar event: {ADDITIONAL}",
	"notification_type_twitterdm" => "Twitter Direct Message",
	"notification_type_email" => "Email",
	"notification_type_none" => "None",
	"notification_type_eqdkp" => "EQdkp Plus",
	"notification_user_new_registered" => "The user {PRIMARY} signed up",
	...
	"manmdkp_title" => 'Point account Management',
	...
	"article_category_empty" => "This articlecategory does not contain any article yet.",
	);
