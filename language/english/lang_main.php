...
$lang = array( 
	...
	"adduser_tab_privacy_options" => 'Privacy',
	...
	"sp_socialshareprivacy" => 'Use 2-click solution',
	"sp_socialshareprivacy_help" => 'With the 2-click solution, date will be transfered to the social networks only after the first click on the appropriate button.',
...
If you are a Facebook member and do not want Facebook to connect the data concerning your visit to our website with your member data already stored by Facebook, please log off Facebook before entering our website. Further you can block Facebook social Plugins by using add-ons for your browser, like the “Facebook Blocker“.',
	...
	"sticky_news_prefix" => '<img src="'.registry::get_const('root_path').'.'.registry::get_const('root_path').'images/glyphs/sticky.png" alt="Sticky" class="absmiddle" /> Sticky:',
	...
	"maintenance_mode_warn" => 'Your system is currently in maintenance mode, restricting normal user access. Please check the <a href="'.registry::get_const('root_path').'.'.registry::get_const('root_path').'">maintenance tool</a> and disable the maintenance mode when done.<ul><li><a href="'.registry::get_const('root_path').'.'.registry::get_const('root_path').'maintenance/task_manager.php">Go to maintenance tool</a></li><li><a href="'.registry::get_const('root_path').'.'.registry::get_const('root_path').'maintenance/task_manager.php?disable=true">Deactivate Maintenance mode</a></li></ul>',
	...
	"age" => 'Age',
	"adduser_work" => 'Occupation',
	"adduser_hardware" => 'Hardware',
	"adduser_interests" => 'Hobbies',
	...
	"raidevent_raid_nochar" => 'Your user ID has not been assigned any characters. In the Character Manager you can create and assign new characters or assign existing characters. <br/> <a href=".'.registry::get_const('root_path').'characters.php">Character Manager</a>',
	...
	"raidevent_raid_val_addevent" => 'There is no capable calendar for adding events. Please add one <a target="_parent" href=".'.registry::get_const('root_path').'admin/manage_calendars.php">here</a>',
	...
	"reply" => 'Reply',
	"user_wall" => 'Wall',
	"user_priv_wall_posts_read" => 'Posts on wall visible for',
	"user_priv_wall_posts_write" => 'Who can create posts on your wall',
