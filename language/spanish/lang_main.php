...
$lang['talents'] = array(
'Hunter'       => array('Bestias','Puntería','Supervivencia'),
'Paladin'      => array('Sagrado','Protección','Retribución'),
'Rogue'        => array('Asesinato','Combate','Sutileza'),
'Warrior'         => array('Armas','Furia','Protección'),
'Priest'          => array('Disciplina','Sagrado','Sombras'),
'Warlock'       => array('Afflicción','Demonología','Destrucción'),
'Druid'           => array('Equilibrio','Combate Feral','Restauración'),
'Mage'         => array('Arcano','Fuego','Escarcha'),
'Shaman'       => array('Elemental','Mejora','Restauración'),
'Death Knight'   => array('Sangre','Escarcha','Profano')
);
