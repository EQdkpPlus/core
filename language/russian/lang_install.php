...
'connection_failed'         => 'Соединение с eqdkp-plus.com не удалось.',
'curl_notavailable'         => 'cURL не доступно. Возможно, Статистика предметов не будет работать правильно.',
'fopen_notavailable'        => 'fopen не доступно. Возможно, Статистика предметов не будет работать правильно.',
...
'inst_error_prefix_inval'   => 'Неправильный префикс',
'inst_error_prefix_toolong' => 'Префикс слишком длинный!',
'inserror_dbconnect'        => 'Ошибка при соединении с базой данных',
