...
"inst_step" => "Etape",
"error_nostructure" => "Impossible d'obtenir la structure de la base de donnée SQL",
"error_template" => "Impossible d'inclure '%s' includes/class_template.php - Vérifiez que le fichier existe",
"stepname_1" => "Informations",
"stepname_2" => "Base de donnée",
"stepname_3" => "Vérification de la base de donnée",
...
"safemode_on" => "PHP Safe Mode est activé. EQDKP-PLUS ne fonctionnera pas en Safe Mode car le répertoire de cache est nécessaire pour certaines opérations.",
...
"inst_dbtype" => "Type de base de données",
...
"inst_mysqlinfo" => "Le client MySQL <b>et</b> la version du serveur 4.0.4 ou plus ainsi que le support des tables InnoDB sont nécessaires pour EQdkp.<br> <b><br>Vous utilisez la version serveur <ul>%s</ul> et la version client <ul>%s.</ul></b><br> les versions MySQL antérieures à 4.0.4 ne fonctionnent pas et ne sont pas supportées. Les versions antérieures à 4.0.4<br> posent des problèmes de corruption de données, et nous ne fourniront aucun support sur ces installations.<br><br>",
