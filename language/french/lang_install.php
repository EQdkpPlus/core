...
'templcache_created'        => "Le répertoire '%1\$s' a été créé, éffacer ce répertoire peu provoquer des disfonctionnements durant l'installation d'EQDKP.",
'templcache_notcreated'     => "Le répertoire '%1\$s' n'a pu être crée, merci de le créer manuellement dans le répertoire des Templates.
                                <br />Vous pouvez le faire en exécutant la commande <b>mkdir -p %1\$s</b> à la racine de votre répertoire EQDKP",
'templcache_notwritable'    => "Le répertoire '%1\$s' existe mais n'est pas configuré en écriture et ne peut pas être modifié automatiquement.
                                <br />Merci de changer les permissions en 0777 manuellement en exécutant la commande <b>chmod 0777 %1\$s</b> sur votre serveur FTP.",
'templatecache_ok'          => "Le répertoire '%1\$s' est correctement configuré en écriture pour permettre à EQDKP-PLUS de créer des fichiers dans ce dossiers.",
'cachefolder_out'           => "Le répertoire '%1\$s' a bien été %2\$s et est %3\$s",
...
'safemode_on'               => 'PHP Safe Mode est activé. EQDKP-PLUS ne fonctionnera pas en Safe Mode car le Data ecrit des prérations.',
...
'inst_found'                => 'trouvé',
'inst_writable'             => 'accessible en écriture',
'inst_notfound'             => 'non trouvé',
'inst_unwritable'           => 'non accessible en écriture',
...
'inst_sql_error'            => "Erreur ! Echec d'\'exécution de la requête SQL : <br><br><ul>%1\$s</ul><br/>",
...
'inst_confwritten'          => 'Votre fichier de configuration a été enregistré avec les valeurs initiales, mais l\'installation ne pourra pas se termniner avant
