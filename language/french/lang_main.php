...
'Guerrier'   	=> array('Armes','Fureur','Protection'),
'Chasseur'    	=> array('Maîtrise des bêtes','Précision','Survie'),
'Prêtre'    	=> array('Discipline','Sacré','Ombre'),
'Démoniste'  	=> array('Affliction','Démonologie','Destruction'),
'Druide'     	=> array('Équilibre','Combat farouche','Restauration'),
'Mage'      	=> array('Arcanes','Feu','Givre'),
'Chaman'    	=> array('Élémentaire','Amélioration','Restauration'),
'Chevalier de la mort'     => array('Sang','Givre','Impie')
);
