...
$lang['recorded_raid_history'] = "Historique des raids enregistrés pour %1\$s";
$lang['reason'] = 'Raison';
...
$lang['listevents_footcount']            = "...  %1\$d évènements trouvés / %2\$d par page";
...
$lang['viewmember_adjustment_footcount'] = "...  %1\$d ajustements individuels trouvés ";
...
$lang['events_per_page'] = 'Evènements par page';
...
$lang['error_invalid_event_provided'] = 'Un ID d\'évènement valide est requis.';
...
$lang['error_invalid_password'] = 'Le mot de passe ne peut pas de contenir " or \'.';
...
// Registration
$lang['account_activated_admin']   = 'Ce compte a été activé. Un email a été envoyé à l\'utilisateur pour l\'avertir de ces changements.';
...
$lang['Multi_events'] 				= "Evènements:";
$lang['Multi_eventname'] 				= "Nom de l\'évènement";
...
$lang['Multi_events'] 				= "Evènements de ce groupe";
...
$lang['Multi_required_event']   = "Vous devez choisir un évènement.";
$lang['Multi_required_name']    = "Vous devez saisir un nom.";
$lang['Multi_required_disc']    = "Vous devez saisir une description.";
$lang['Multi_admin_add_multi_success'] = "Le groupe %1\$s ( %2\$s ) avec les évènements %3\$s a été ajouté.";
$lang['Multi_admin_update_multi_success'] = "Le groupe %1\$s ( %2\$s ) avec les évènements %3\$s a été modifié.";
...
// Event Icon
$lang['event_icon_header']    								  = 'Choisissez un icône d\'évènement';
...
$lang['updi_curl_bad']    								    = 'La fonction PHP cURL n\'a pas été trouvée. Itemstats ne fonctionnera pas correctement. Contactez l\'Administrateur.';
$lang['updi_curl_ok']    								    	= 'cURL trouvé.';
$lang['updi_fopen_bad']    								    = 'La fonction PHP fopen n\'a pas été trouvée. Itemstats ne fonctionnera pas correctement. Contactez l\'Administrateur.';
$lang['updi_fopen_ok']    								    = 'fopen trouvé.';
...
# Reset DB Feature
$lang['reset_header']    			= 'Réinitialiser les données EQDKP';
...
$lang['reset_news_disc']		  = 'Effacer toutes les nouvelles de la base de donnée.';
$lang['reset_dkp'] 					  = 'DKP';
$lang['reset_dkp_disc']			  = 'Effacer tous les raids et objets de la base de donnée. Remise à zéro de tous les points DKP.';
$lang['reset_ALL']   					= 'TOUT';
$lang['reset_ALL_DISC']				= 'Effacer tous les raids, les objets et les membres. Remise à zéro complète. (Ne supprime pas les utilisateurs).';
...
$lang['updi_update_alternative']= 'Méthode secondaire de mise à jour pour éviter les timeouts (délais d\'attente dépassé).';
...
$lang['shirt_ad4']					    = 'Choisit un des produits préconcus , ou réalise-toi s\'en un qui te soit propre avec le créateur de T-shirt.<br>
...
'Hunter'    	=> array('Maîtrise des bêtes','Précision','Survie'),
'Priest'    	=> array('Discipline','Sacré','Ombre'),
'Warlock'  	=> array('Affliction','Démonologie','Destruction'),
'Druid'     	=> array('Équilibre','Combat farouche','Restauration'),
'Mage'      	=> array('Arcane','Feu','Givre'),
'Shaman'    	=> array('Élémentaire','Amélioration','Restauration'),
'Death Knight'     => array('Sang','Givre','Impie')
);

$lang['portalmanager'] = 'Gérer les modules du portail';

$lang['air_img_resize_warning_new'] = 'Cliquez cette barre pour afficher l\\\'image entière.';
$lang['air_img_resize_warning'] = 'Cliquez cette barre pour afficher l\\\'image entière. L\\\'original est %1$sx%2$s.'; //double escaping needed, because it's used in single quotes in a js-function
...
$lang['libloader_tooold']       = "La librairie '%1\$s' est périmée. Vous devez télécharger la Version %2\$s ou supérieure.<br/>
...
$lang['libloader_tooold_plug']  = "The Library Module '%1\$s' est périmée. La version %2\$s ou supérieure est nécessaire.
                                  This is included in the Libraries %4\$s or higher. Votre version actuelle de Librairies est la %5\$s<br/>
                                  Télégarger: <a href='%3\$s' target='blank'>Librairies</a><br/>
                                  Téléchargez, et écrasez la version existante dans le répertoire 'eqdkp/libraries/' !";
...
$lang['adduser_birthday'] = 'Anniversaire format: JJ.MM.AAAA';
$lang['adduser_gender_m'] = 'Homme';
$lang['adduser_gender_f'] = 'Femme';
...
$lang['pcache_safemode_error']  = 'Safe Mode activé. EQDKP-PLUS will not work wile it xould not write data to the cache folders in safe mode.';
...
$lang['aiupload_upload_again']  = 'Télécharger à nouveau';
...
//Usersettings
$lang['user_list'] = 'Contact'; 
$lang['user_priv'] = 'Configuration personnelle SMS (SMS non activés pour le moment)';
$lang['user_priv_set_global'] = 'Qui peut accéder aux données telles que Skype et MSN?';
$lang['user_priv_set'] = 'Visible pour ';
$lang['user_priv_all'] = 'Tous';
$lang['user_priv_user'] = 'Utilisateur enregistré';
$lang['user_priv_admin'] = 'Administrateur seulement';
$lang['user_priv_rl'] = 'Administrateur du Raidplaner';
$lang['user_priv_no'] = 'Personne';
$lang['user_priv_tel_all'] = 'Les numéros de téléphone sont visibles par tous les utilisateurs enregistrés au lieu des Administrateur seulement ? ';
$lang['user_priv_tel_cript'] = 'Les numéros de téléphone sont invisible pour tous, même pour les administrateur ? (l\'envoi de SMS reste toujours possible) ';
$lang['user_priv_tel_sms'] = 'Désactiver la réception des SMS venant des administrateurs. (Réception d\'invitations de raid via SMS non possible) ';

// Image & BBCode Handling
$lang['images_not_available']	= 'The embedded image is not available at the moment';
$lang['images_not_available_admin']	= '<b>The embedded image could not be checked</b><br/>There are several reasons why this could happen:<br/>- Dynamic generated images are disabled for security reasons<br/>- blocked external connections: Try paths instead of URL';
$lang['images_userposted']		= 'Image postée par un utilisateur';


//SMS
$lang['sms_perm']	= 'Service SMS';
$lang['sms_perm2']	= 'Envoyer SMS';
$lang['sms_header'] = 'Envoyer SMS';
$lang['sms_info'] = 'Envoyez le SMS aux utilisateurs, par exemple quand un raid a été annulé ou vous avez besoin de joueurs supplémentaires à la dernière minute.';
$lang['sms_info_account'] = "Vous n'avez pas encore de compte d\'envoi de SMS  ? Demandez-le maintenant.";
$lang['sms_info_account_link'] = '<a href=http://www.eqdkp-plus.com target=_blank> --> Liens</a>';
$lang['sms_send_info'] = 'Pour pouvoir envoyer des SMS, vous devez choisir un utilisateur ayant un numéro de téléphone portable valable et un texte doit être entré.';
$lang['sms_success'] = 'Sms envoyé(s) avec succès au serveur. Cela peut prendre quelques minutes avant que les messages ne soient envoyés au destinataire.';
$lang['sms_error'] = 'Une erreur est survenue pendant l\'envoi du SMS.';
$lang['sms_error_badpw'] = 'Une erreur est survenue en envoyant le SMS. Mot de passe de l\'expéditeur incorrect.';
$lang['sms_error_bad']   = 'Une erreur est survenue en envoyant le SMS. Crédit de SMS épuisé.';
$lang['sms_error_fopen'] = "Une erreur est survenue en envoyant le SMS. Le serveur ne pouvait pas établir de connexion fopen au relais de SMS. Le serveur de SMS n'est pas disponible pour le moment ou votre serveur n\'accepte pas de connexion fopen. Dans ce cas, contactez votre hébergeur/administrateur. (Ne contactez pas l\'équipe EQDKPPLUS!!)";
$lang['sms_error_159']   = 'Une erreur est survenue en envoyant le SMS. Service-ID inconnu.';
$lang['sms_error_160']   = 'Une erreur est survenue en envoyant le SMS. Message non trouvé!';
$lang['sms_error_200']   = 'Une erreur est survenue en envoyant le SMS. Erreur fatale. Script XML incomplet';
$lang['sms_error_254']   = 'Une erreur est survenue en envoyant le SMS. Le message a été effacé !';
...
$lang = array_merge($lang, array(
  ...
  'cl_update_available'       => "Mettez a jour le module <i>%1\$s</i> .
                                  Votre version actuelle est la <b>%2\$s</b> et la dernière version est la <b>%3\$s (Sortie le: %4\$s)</b>.<br/><br/>
                                  [Sortie : %5\$s]%6\$s%7\$s",
  'cl_update_url'             => 'Page de téléchargement',
  ...
  'cl_upd_reload_txt'         => 'Les réglages rechargent, attendez s\'il vous plaît...',
  ...
  // ReCaptcha Library
	...
	'lib_captcha_insertnumbers' => 'Entrez les numéros',
	'lib_captcha_send'			=> 'envoi du code de confirmation',
...
//date/time style
$lang['style_date_notime_long']      = 'j F, Y' ;
$lang['style_date_notime_short']   = 'd/m/y' ;
$lang['style_date_time']         = 'd/m/y H:i T' ;
$lang['style_time']               = 'H:i';
$lang['style_strtime_date']         = '%A %d %B %Y';
$lang['style_strtime_date_short']     = '%a %m.%d %I:%M %p';

$lang['mini_games'] 		 	= 'Mini jeux';
