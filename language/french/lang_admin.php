...
$lang['addevent_title']       = 'Ajouter un évènement';
...
$lang['config_title']         = 'Script de configuration';
...
$lang['plugins_title']        = 'Gérer les modules';
...
$lang['delete_event'] = 'Supprimer un évènement';
...
$lang['mass_delete'] = 'Suppression multiple';
$lang['mass_update'] = 'Mise à jour multiple';
...
$lang['list_prefix'] = 'Préfixe de liste';
$lang['list_suffix'] = 'Suffixe de liste';
$lang['logs'] = 'Logs';
$lang['log_find_all'] = 'Chercher tout (anonymes compris)';
$lang['manage_members'] = 'Gérer les membres';
$lang['manage_plugins'] = 'Gérer les modules';
$lang['manage_users'] = 'Gérer les utilisateurs';
$lang['mass_update_note'] = 'Si vous souhaitez appliquer les modifications à tous les membres sélectionnés, utilisez ces commandes pour changer leurs propriétés et cliquez sur "Mise à jour multiple".
                             Pour effacer les comptes sélectionnés, cliquez uniquement sur "Suppression multiple".';
$lang['members'] = 'Membres';
$lang['member_rank'] = 'Rang du membre';
$lang['message_body'] = 'Corps du texte';
$lang['message_show_loot_raid'] = 'Afficher les loots du raid :';
$lang['results'] = "%1\$d Résultatss (\"%2\$s\")";
...
$lang['noauth_a_plugins_man']  = 'Vous n\'avez pas la permission de gérer les modules.';
...
$lang['admin_update_account_success']        = "Vos paramètres ont été mis à jour.";
...
$lang['confirm_delete_event']   = 'Etes-vous certain de vouloir supprimer cet évènement ?';
...
// Log Actions
$lang['action_event_added']      = 'Evènement ajouté';
$lang['action_event_deleted']    = 'Evènement supprimé';
$lang['action_event_updated']    = 'Evènement mis à jour';
...
$lang['event_after']       = 'Evènement après';
$lang['event_before']      = 'Evènement avant';
...
$lang['hide_inactive_note'] = 'Cacher les membres qui n\'ont pas participés à un raid depuis [période d\'inactivité] jours ?';
...
$lang['plugins'] = 'Modules';
$lang['no_plugins'] = 'Le dossier des modules (./plugins/) est vide.';
...
$lang['error_invalid_plugin']     = 'Un module valide n\' pas été fourni.';
...
$lang['vlog_item_deleted']     = "%1\$s a supprimé l\'objet '%2\$s' à la charge de %3\$d membres.";
...
$lang['listing_events'] = 'Liste les évènements';
...
$lang['managing_plugins'] = 'Gère les modules';
...
$lang['viewing_event'] = 'Regarde les évènements';
...
$lang['backup_database']   = 'Sauvegarder la DB';
$lang['backup_title']      = 'Créer une sauvegarde de la DB';
...
$lang['backup_no_table_prefix']    = '<strong>ATTENTION:</strong> Votre installation d\'EQdkp n\'a pas de préfixe pour ses tables. Toutes les tables des modules ne seront pas sauvegardées.';

// plus
$lang['in_database']  = 'Sauvegardé dans la base de donnée';
...
$lang['plugin_inst_message']  = "Le module <i>%1\$s</i> a été correctement %2\$s.";
$lang['plugin_inst_installed'] = 'installé';
$lang['plugin_inst_uninstalled'] = 'désinstallé';
$lang['plugin_inst_errormsg1'] = "Des erreurs ont été détectées durant le processus d\'%1\$s : %2\$s";
...
$lang['css_file'] = 'Fichier CSS - ignore la plupart des réglages de couleur sur ce site. [optionel]';

$lang['plugin_inst_sql_note'] = 'Une erreur SQL n\'implique pas forcément une mauvais installation du module. Esssayez le module et si des erreurs se produisent, désinstallez et installez de nouveau.';

// Plugin Update Warn Class
$lang['puc_perform_intro']          = 'Les modules suivants nécessitent une mise à jour dans la structure de leur base de données. Cliquez sur le lien "Résoudre" afin d\'effectuer les modifications pour chaque module.<br/>Les tables suivantes sont périmées :';
$lang['puc_pluginneedupdate']       = "<b>%1\$s</b>: (Requiert une mise à jour de base de donnée de %2\$s à %3\$s)";
$lang['puc_solve_dbissues']         = 'résoudre';
$lang['puc_unknown']                = '[inconnu]';

$lang['plus_cache_reset_done']      = 'Réinitialisation effectuée!';
$lang['plus_cache_reset_name']      = 'Plus Data Cache';

// Update Check PLUS
$lang['lib_pupd_intro']             = 'De nouvelles versions sont disponibles:';
$lang['lib_pupd_updtxt']            = "<b>%1\$s</b>: %2\$s (installé: %3\$s), disponible depuis le %4\$s";
$lang['lib_pupd_noupdates']         = 'EQDKP-PLUS et tous les plugins sont à jour! Il n\'y a actuellement aucune mise à jour disponible. Veuillez revérifier plus tard...';
$lang['lib_pupd_nodbupdates']       = 'Toutes les bases de données sont à jour! Aucune mise à jour n\'est nécessaire.';
$lang['lib_pupd_changelog']         = 'Modifications';
$lang['lib_pupd_nochangelog']       = 'Pas d\'information disponible sur les modifications';
$lang['lib_pupd_download']          = 'Télécharger';
$lang['lib_pupd_checknow']          = 'Vérifier à nouveau les mises à jour!';

// RSS News
$lang['rssadmin_head1']             = 'Notifications';
$lang['rssadmin_head2']             = 'Eqdkp-Plus News';
$lang['rssadmin_head3']             = 'Eqdkp-Plus Twitter Feed';

// Admin Info Center
$lang['adminc_information']         = 'Information';
$lang['adminc_news']                = 'Nouvelles';
$lang['adminc_updtcheck']           = 'Mises à jour';
$lang['adminc_statistics']          = 'Statistiques';
$lang['adminc_server']              = 'PHP Info';
$lang['adminc_support']             = 'Support';
$lang['adminc_phpvalue']            = 'Value';
$lang['adminc_phpname']             = 'PHP Setting name';
$lang['adminc_info_dbupdates_av']   = 'Toutes les base de données des plugins installés ne sont pas à jour. Cliquez sur l\'onglet "Mises à jour" pour de plus amples informations.';
$lang['adminc_info_updates_av']     = 'De nouvelles mises à jour sont disponibles. Cliquez sur l\'onglet "Mises à jour" pour de plus amples informations.';
$lang['adminc_support_intro']       = "Si vous avez des questions concernant EQDKP-PLUS, soyez certain d'avoir visité les ressources suivantes.";
$lang['adminc_support_wiki']        = "Le WIKI est un système de documentation en ligne. Vous y trouverez de nombreuses réponses, faq, et d'autres choses encore.<br>Les utilisateurs sont encouragés à écrire leurs propres articles et aider la communauté.<br><a href='http://wiki.eqdkp-plus.com' target='blank'>Vers le WIKI</a>";
$lang['adminc_support_bugtracker']  = "Vous rencontrez un bug? Aidez-nous en recherchant d'abord dans le bugtracker, ouvrez un nouveau rapport si nécessaire<br><a href='http://bugtracker.eqdkp-plus.com' target='blank'>Vers le Bugtracker</a>";
$lang['adminc_support_forums']      = "Vous avez des questions ou besoin d'aide? Vous avez chercher dans le WIKI sans trouver de réponse? Alors visitez les forums officiels pour obtenir de l'aide<br><a href='http://www.eqdkp-plus.com/forum' target='blank'>Vers les Forums</a>"
?>
