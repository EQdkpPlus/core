...
// lua
$lang['lua'] = "CT_RaidTracker 导入";
$lang['lua_parse'] = "导入 LUA";
$lang['import_lua_data'] = "导入 CT_RaidTracker 数据";
$lang['lua_step1_pagetitel'] = "CT_Raidtracker 导入";
$lang['lua_step1_th'] = "在下面粘贴日志";
$lang['lua_step1_button_parselog'] = "处理日志";
$lang['lua_step1_invalidstring_titel'] = "无效 DKP 字符串";
$lang['lua_step1_invalidstring_msg'] = "DKP 字符串是无效的。";
$lang['lua_step1_button_parselog'] = "处理日志";
$lang['lua_step2_pagetitel'] = "CT_Raidtracker 导入";
$lang['lua_step2_foundraids'] = "找到 Raids";
$lang['lua_step2_dkpvaluetip'] = "添加物品值/出席者";
$lang['lua_step2_insertraids'] = "插入 Raid(s)";
$lang['lua_step2_raidsdropsdetails'] = "Raid/掉落详细";
$lang['lua_step3_pagetitel'] = "CT_Raidtracker 导入";
$lang['lua_step3_titel'] = "操作日志<br>\n";
$lang['lua_step3_alreadyexist'] = "%s (%s, %s DKP) 已经被添加，跳过<br>\n";
$lang['lua_step3_raidadded'] = "%s (%s, %s DKP) 已被添加<br>\n";
$lang['lua_step3_memberadded'] = "%s (种族: %s, 职业: %s, 等级: %s, 头衔: %s) 已被添加到成员<br>\n";
$lang['lua_step3_attendeesadded'] = "%s 出席者已被添加<br>\n";
$lang['lua_step3_lootadded'] = "%s (%s DKP) 已被添加到 %s<br>\n";
...
$lang['news_ext_message']  			  	= 'Extended News';
