...
$lang = array(
	...
	//Navigation
	'navi'	=> '<ul><li><a href="?tour=next"><b>Mit dem nächsten Schritt der Tour fortfahren</b></a></li><li><a href="?tour=reload">Schritt erneut anzeigen</a></li><li><a href="?tour=cancel">Tour beenden</a></li></ul>', 'EQdkp Plus Tour',
	...
	//Step2 - Plugins
	'step_2'	=> 'Plugins sind Erweiterungen, die die Funktionalität deines EQdkp Plus ausbauen. Um ein Plugin zu installieren, klicke einfach auf "Installieren".<br /><br />Empfohlene Plugins:<ul><li>Raidplan: plane Raids, zu denen sich deine Mitglieder anmelden können</li><li>Raidlogimport: importiere Raidlogs aus Ingame-Addons</li></ul>',
	...
	//Step7 - Manage Infopages
	'step_7'	=> 'Natürlich gehört zu einem CMS, dass man eigene Seiten erstellen kann.<br >Mit einem umfangreichen Editor und dem Upload-Manager bleiben beim Erstellen der eigenen Seiten keine Wünsche offen.<br ><br >Doch nicht nur das - du kannst hier auf Gildenregeln erstellen, die jeder Benutzer bei der Registrierung bestätigen muss.<br /><br />Mehr Informationen zum Thema "Eigene CMS-Seiten erstellen" findest du in <a href="http://wiki.eqdkp-plus.com/de/index.php/Infoseiten" target="_blank" style="color:#000;">diesem Wiki-Artikel</a>',
	'step_7_title'	=> 'eigene CMS-Seiten erstellen',

	//Step8 - Backup
	'step_8'	=> 'Jeder kennt das Problem - der PC geht kaputt, und die Sicherung wurde vergessen.<br /><br />Dies kann nicht mehr vorkommen!<br /><br />Nicht nur, dass man nun auch Backups wiederherstellen kann, sondern es ist auch möglich, automatisiert Backups erstellen zu lassen. Die Optionen hierfür findet ihr unter dem Menüpunkt "Zeitgesteuerte Aufgaben verwalten" <br /><br />Mehr Informationen zum Thema "Sicherung" findest du in <a href="http://wiki.eqdkp-plus.com/de/index.php/Sicherung" target="_blank" style="color:#000;">diesem Wiki-Artikel</a>',
	'step_8_title'	=> 'Sicherung',
	
	//Step9 - End
	'step_9'	=> 'Vielen Dank, dass du diese Tour durch das EQdkp Plus mitgemacht hast.<br><br>Solltest du noch Fragen haben, kannst du <ul><li>in unserer <a href="http://wiki.eqdkp-plus.com/" style="color:#000">Wiki</a> nachlesen</li><li>oder in unserem <a href="http://eqdkp-plus.com/forum" style="color:#000">Forum</a>.</li></ul> Du kannst diese Tour jederzeit wiederholen, in dem du auf der Startseite des Adminbereiches in den Tab "Support" gehst.<br /><br />Viel Spaß wünscht das gesamte EQdkp Plus Team',
	'step_9_title'	=> 'Ende',
