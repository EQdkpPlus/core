...
// Update Check PLUS
$lang['lib_pupd_intro']             = 'Es wurden folgende Updates gefunden:';
$lang['lib_pupd_updtxt']            = "<b>%1\$s</b>: %2\$s (installiert: %3\$s), veröffentlicht am %4\$s";
$lang['lib_pupd_noupdates']         = 'Alle EQDKP-PLUS Plugins sind aktuell! Es sind zur zeit keine Updates verfügbar. Bitte regelmäßig überprüfen...';
$lang['lib_pupd_nodbupdates']       = 'Alle Plugin Datenbanktabellen sind aktuell! Es sind zur zeit keine Updates nötig.';
...
$lang['adminc_info_dbupdates_av']   = 'Nicht alle Datenbanktabellen der installierten Plugins sind aktuell. Bitte besuche den "Aktualisierungen" Tab um weitere Informationen zu erhalten.';
$lang['adminc_info_updates_av']     = 'Es sind neue Updates verfügbar. Bitte besuche den "Aktualisierungen" Tab um weitere Informationen zu erhalten.';
...
$lang['adminc_support_wiki']        = "Das WIKI ist ein Online Dokumentationssystem. Es gibt viele Artikel, FAQ und Antworten. Benutzer werden dazu ermuntert, eigene Artikel zu schreiben und somit der Community zu helfen.<br><a href='http://wiki.eqdkp-plus.com' target='blank'>Zum WIKI</a>";
$lang['adminc_support_bugtracker']  = "Du hast einen Bug gefunden? Dann hilf uns: Durchsuche zuerst den Bugtracker, und melde nicht vorhandene Fehler.<br><a href='http://bugtracker.eqdkp-plus.com' target='blank'>Zum Bugtracker</a>";
$lang['adminc_support_forums']      = "Du hast Fragen rund um das EQDKP-PLUS? Benötigst Hilfe und das WIKI hat dir nicht weitergeholfen? Besuche das offizielle Forum!<br><a href='http://www.eqdkp-plus.com/forum' target='blank'>Zum Forum</a>"
?>
