...
$lang['mass_update_note'] = 'Wenn Du die Änderungen zu allen ausgewählten Accounts durchführen willst, benutze diese Einstellungen und klick auf "Massenupdate".
                            Um die ausgewählten Accounts zu löschen, klicke auf "Massenlöschung".';
...
$lang['noauth_a_event_del']    = 'Du hast keine Berechtigung to delete events zu löschen.';
...
$lang['confirm_delete_adj']     = 'Bist Du sicher, daß Du diese Gruppenkorrektur löschen willst?';
$lang['confirm_delete_admins']  = 'Bist Du sicher, daß Du die ausgewählten Admins löschen willst?';
$lang['confirm_delete_event']   = 'Bist Du sicher, daß Du dieses Ereignis löschen willst?';
$lang['confirm_delete_iadj']    = 'Bist Du sicher, daß Du diese individuelle Korrektur löschen willst?';
$lang['confirm_delete_item']    = 'Bist Du sicher, daß Du dieses Item löschen willst?';
$lang['confirm_delete_members'] = 'Bist Du sicher, daß Du die folgenden Mitglieder löschen willst?';
$lang['confirm_delete_news']    = 'Bist Du sicher, daß Du diesen Newsbeitrag löschen willst?';
$lang['confirm_delete_raid']    = 'Bist Du sicher, daß Du diesen Raid löschen willst?';
$lang['confirm_delete_style']   = 'Bist Du sicher, daß Du diesen Style löschen willst?';
$lang['confirm_delete_users']   = 'Bist Du sicher, daß Du die folgenden Benutzeraccounts löschen willst?';
...
$lang['action_indivadj_added']   = 'Individuell Korrektur zugefügt';
$lang['action_indivadj_deleted'] = 'Individuell Korrektur gelöscht';
...
$lang['default_locale'] = 'Standardregion (nur Zeichensatz; beeinflußt nicht die Sprache)';
...
$lang['show_item_stats_note'] = 'Versuche Itemeigenschaften aus dem Internet zu holen.  Kann die Geschwindigkeit des Seitenaufbaus beeinflußen.';
...
$lang['default_permissions_note'] = 'Das sind die Berechtigungen für Benutzer, die nicht eingeloggt sind und wird neuen Benutzern bei der Registrierung gegeben. Punkte in <b>fett</b> sind administrative Berechtigungen,
                                    die man besser nicht als standard setzen sollte. Punkte in <i>cursiv</i> sind nur für Plugins.  Du kannst später individuelle Benutzereinstellungen im Administrationsbereich vergeben.';
...
$lang['admin_email'] = 'Administrator E-Mailaddresse';
...
$lang['style_date_note'] = 'Für Datum-/Zeitfelder wird die PHP-Syntax genommen <a href="http://www.php.net/manual/en/function.date.php" target="_blank">date()</a> function.';
...
$lang['i_help'] = 'kursiver Text: [i]Text[/i] (alt+i)';
...
$lang['p_help'] = 'Bild einfügen: [img]http://bild_url[/img] (alt+p)';
...
$lang['backup_title'] = 'Erstelle einer Datenbanksicherung';
$lang['create_table'] = '\'CREATE TABLE\' hinzufügen?';
