...
'templcache_notcreated'     => 'Der Cache-Template Order konnte nicht angelegt werden, Bitte diesen händisch anlegen.
                                <br />Gebe dazu ein: <b>mkdir -p templates/cache/</b>',
'templatecache_created'     => 'Der Cache-Template Order wurde erfolgreich angelegt. Bitte diesen Ordner jetzt nicht löschen!',
'templatecache_chmod'       => 'Der Cache-Template Order existiert, kann aber nicht beschrieben werden. Der Order muss beschreibbar sein.
                                <br />Bitte setze die Berechtigung auf 0777 indem <b>chmod 0777 templates/cache</b> eingegeben wird.',
'templatecache_ok'          => 'Der Cache-Template Order wurde erfolgreich angelegt.',
...
'inst_error_prefix_toolong' => 'Tabellen Präfix ist zu lang! Bitte gib ein kürzeres ein!',
...
'insterror_prefix'          => 'Eine Eqdkp Installation mit diesem Präfix existiert bereits. Beim fortsetzen der Installation werden alle vorhandenen Tabellen gelöscht, alle Daten gehen dabei unwiderruflich verloren! Benutze den Zurück-Button des Browsers um ein anderes Präfix anzugeben, oder klicke auf "Weiter" um mit der Installation weiter zu machen.',
...
'inst_user_email'           => 'Administrator Email Adresse',
...
'inst_confwritten'          => 'Die Konfiguarationsdatei konnte nur mit Standartwerten geschrieben werden. Erstelle nun einen Admin-Account.',
...
'inst_failedversioninfo'    => "Konnte keine Versioninformationen der Datenbank <b>%s</b> als <b>%s@%s anrufen.</b>
                                <br /><br /><a href='index.php'>Installation wiederholen</a>",
...
'inst_admin_created'        => 'Das Administratorkonto wurde erfolgreich angelegt. Einloggen um das Eqdkp Plus weiter einzurichten.',
);
?>
