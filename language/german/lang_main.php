...
"user_sett_f_first_name" => "Vorname",
"user_sett_f_last_name" => "Nachname",
"user_sett_f_gender" => "Geschlecht",
"gender_m" => "Männlich",
"gender_f" => "Weiblich",
"user_sett_f_country" => "Land",
"user_sett_f_state" => "Bundesland",
"user_sett_f_ZIP_code" => "Postleitzahl",
...
"user_sett_f_help_cellphone" => "Du kannst unter &raquo;Privatsspähre&laquo; einstellen, wer Zugriff auf deine Handynunmmer haben darf. Über die Handynummer kannst Du Dir z.B. anonym eine SMS senden lassen, wenn neue Termine anstehen, oder ein Raid abgesagt wurde.",
"user_sett_f_icq" => "ICQ Nummer",
"user_sett_f_skype" => "Skype Name",
"user_sett_f_youtube" => "Youtube Account",
"user_sett_f_twitter" => "Twitter Account",
"user_sett_f_facebook" => "Facebook-ID",
"user_sett_f_irq" => "IRC Server & Channel",

"user_sett_fs_misc" => "Sonstiges",
"user_sett_f_work" => "Tätigkeit/Beruf",
"user_sett_f_hardware" => "Hardware",
"user_sett_f_interests" => "Interessen",

"user_sett_tab_privacy_options" => "Privatsphäre",
"user_sett_fs_user_priv" => "Kontakt",
"user_sett_f_priv_no_boardemails" => "Email-Empfang für Systemmails wie Kalender, Massenemail usw. deaktiveren",
"user_sett_f_priv_set" => "Kontaktdaten wie Email, Skype, ICQ einsehbar für",
"user_sett_f_priv_phone" => "Telenfonnummern einsehbar für",
"user_sett_f_priv_nosms" => "<b>SMS-Empfang durch Admins deaktivieren</b><br />(Es können dann keine Raideinladungen per SMS empfangen werden)",
