...
"calendar_awaymode_enabled" => "Statusänderung des Abwesenheitsmodus",
"calendar_awaymode_startdate" => "Starttag der Abwesenheit",
...
"calendar_eventlabel_open" => "Öffentlich",
"calendar_eventlabel_private" => "Privat",
"calendar_event_detail_invitedby" => "Eingeladen von",
"calendar_event_detail_createdby" => "Erstellt von",
...
"hptt_empty_table" => "Keine Einträge gefunden...",
...
"fv_required_password_repeat" => "Die eingegebenen Passwörter stimmen nicht überein.",
"fv_email_not_match" => "Die eingegebenen E-Mail-Adressen stimmen nicht überein",
...
"tableentries_per_page" => "Tabelleneinträge pro Seite",
...
"error_account_locked" => "Dein Account wurde gesperrt. Eine Anmeldung ist nicht möglich. Für Fragen wende dich bitte an deinen Administrator.",
...
"password_resend_success" => "Sofern eine Account mit den eingegebenen Daten gefunden werden kann, erhältst du eine Email mit Informationen zur Passwortänderung.",
...
"email_subject_activation_admin" => "Account Aktivierung ausstehend",
...
"uc_del_warning" => "Soll der Charakter wirklich gelöscht werden? Alle Punkte und Gegenstände gehen unweigerlich verloren.",
"member_active" => "Aktiv?",
...
"belonging_mdkppools" => "Zugehörige Punktekonten",
"belonging_itempools" => "Zugehörige Itemkonten",
...
"calendar_repeat_custom" => "Eigene Eingabe",
"calendar_log_repeat_0" => 'Einzelereignis',
"calendar_log_repeat_7" => 'wöchentlich',
"calendar_log_repeat_1" => 'täglich',
"calendar_log_repeat_14" => '14 tägig',
...
"calendar_sharing_receipients_raidgroup" => 'Raidgruppe einladen',
"calendar_event_private" => 'Privater Termin',
"calendar_raid_private" => 'Privater Raid',
"raidevent_repeat_raid_text" => "Das Ereignis wird %1\$s wiederholt",
"raidevent_repeat_raid_days" => "%1\$s Tage",
...
"optgroup_templates" => "Vorlagen",
"optgroup_lastraids" => "Zuletzt angelegt",
...
"raidevent_raid_note_mainchar" => 'Automatisch als Hauptcharakter hinzugefügt',
"raidevent_raid_note_attendance" => 'Automatisch auf Grund Raidbeteiligung hinzugefügt',
...
"raidevent_transform_raidgroup" => 'Nach Raidgruppe filtern: ',
...
"raidevent_raidtransformedby" => "Raidereignis umgewandelt von %s",
"raidevent_dragdrop_movesuccessmsg" => "Die Änderung am Teilnehmer wurde erfolgreich gespeichert.",
"raidevent_dragdrop_moveerrormsg" => "Beim Verschieben des Teilnehmers ist ein Fehler aufgetreten. Versuche es noch einmal.",
...
"home"	=> "Home",
"select_mdkppool" => "Punktekonto auswählen",
...
"user_sett_f_ntfy_calendarevent_invitation" => "Einladung zu einem Kalenderevent",
...
"notification_calendarevent_new" => "Es wurde ein neues Kalenderevent angelegt: {ADDITIONAL}",
"notification_calendarevent_invitation" => "{PRIMARY} hat dich zu einem Termin eingeladen: {ADDITIONAL}",
"notification_user_new_registered" => "Der Benutzer {PRIMARY} hat sich neu registriert",
...
"manmdkp_title" => "Punktekonten verwalten",
...
"manitempools_title" => "Itemkonten verwalten",
