...
$lang['new_password_note'] = 'Du brauchst nur ein neues Paswort eingeben, wenn Du es ändern willst';
...
$lang['reset_infotext']  			= 'ACHTUNG, das löschen der Daten kann nicht rückgängig gemacht werden! Alle eingetragenen Daten werden unwiederbringlich gelöscht. Legt euch unbedingt ein Backup eurer Daten an. <br> Um eine der Aktionen auszuführen, müsst ihr als Bestätigung, das löschen mit der Eingabe von "LÖSCHEN" in das Eingabefeld bestätigen.';
...
$lang['reset_dkp_disc']			  = 'Löscht alle Raids, alles eingetragenen Items und setzt alle DKP Punkte wieder auf null. Die angelegten Member haben wieder 0 DKP.';
$lang['reset_ALL']   					= 'ALLES';
$lang['reset_ALL_DISC']				= 'Löscht die gesammte Datenbank. Es werden alle Member, Raids und Items gelöscht. Nur die User bleiben erhalten.';
...
$lang['updi_update_alternative']= 'Alle Items löschen und aktualisieren - Alternatives Update, welches eine Timeout bzw. einen "Memory Size" Fehler verhindern soll';
