...
// this it the language shown in your battlenet armory link
// p.e. http://eu.battle.net/wow/de/character/.....
$lang['armory_linklanguage'] = 'de';
...
$lang['air_img_resize_warning_new'] = 'Das Bild wurde verkleinert. Auf das Bild klicken zum öffnen.';
...
$lang['sf_text'] 		 		= '<b>Shakes & Fidget - The Game</b><br><br>
								   Das lustige Rollenspiel zum Kult-Comic! Bastle Deinen eigenen Helden und tauch ein in eine gefährliche Welt voller Monsterhäschen und Höllenbräute!
									<br><br>
									Besteh spannende Abenteuer oder plätte Mitspieler in der Arena! Sammle Erfahrung, gewinne Gold, erlange Ehre und gründe zusammen mit Freunden Deine eigene Gilde!
									<br><br>
									Verprasse Deinen Lohn für abgefahrene neue Ausrüstung – vom echten Schwert bis zum falschen Schnurrbart!';
$lang['popmog_text'] 		 		= 'Bei POPMOG zockst Du coole Browsergames. Egal ob als Freibeuter, Space Invader oder Drachenzüchter .. bei POPMOG spielst DU immer im Team!<br><br>
										<ul><li> Ständig neue Games</li>
										<li> Zocke mit coolen anderen Gamern</li>
										<li> Sammle wertvolle *Honor Points* (Erfahrungspunkte)</li>
										<li> Steige in den Ranglisten auf!</li></ul>
										';
$lang['pm_games'] 		 	= 'Games';
$lang['pm_player'] 		 	= 'Top Player';
$lang['pm_activity'] 	 	= 'Aktivitäten';
$lang['sf_image'] 	 		= 'sf_de.png';
$lang['pm_image'] 	 		= 'pm_de.png';
#$lang['']    								  = '';
?>