 ...
 *
 * $Id: viewevent.php 4 2006-05-08 17:01:47Z tsigo $
 *
 ******************************/
...
if ( (isset($_GET[URI_EVENT])) && (intval($_GET[URI_EVENT] > 0)) )
{
    ...
    while ( $row = $db->fetch_record($result) )
    {
        $tpl->assign_block_vars('items_row', array(
            ...
            'NAME'          => ( $conf_plus['pk_itemstats'] == 1 ) ? itemstats_decorate_name(stripslashes($row['item_name'])) : stripslashes($row['item_name']),
