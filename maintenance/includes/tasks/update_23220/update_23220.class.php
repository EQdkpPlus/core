...
class update_23220 extends sql_update_task {
	...
	public function __construct(){
		...
		$this->sqls = array(
				1	=> "ALTER TABLE `__auth_users` CHANGE COLUMN `user_id` `user_id` INT(11) UNSIGNED NOT NULL;",
	...
	CHANGE COLUMN `user_id` `user_id` INT(11) UNSIGNED NOT NULL",
				4	=> "ALTER TABLE `__adjustments` CHANGE COLUMN `member_id` `member_id` INT(11) UNSIGNED NOT NULL;",
				
				5	=> "ALTER TABLE `__events` CHANGE COLUMN `event_id` `event_id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT;",
				6	=> "ALTER TABLE `__items` CHANGE COLUMN `member_id` `member_id` INT(11) UNSIGNED NOT NULL;",
				7	=> "ALTER TABLE `__members`
	CHANGE COLUMN `member_id` `member_id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
	...
	CHANGE COLUMN `multidkp2event_event_id` `multidkp2event_event_id` INT(11) NOT NULL;",
