...
$lang['which_plugins'] = 'Which of your old plugins shall be imported? You must install them to import the data and plugins you have already installed in 0.7 won\'t be imported. Uninstall them and do this step again in order to import the data for those.';
