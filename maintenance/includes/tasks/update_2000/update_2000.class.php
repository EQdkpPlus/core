	...
	public function __construct(){
		...
		$this->langs = array(
			'english' => array(
				...
				114	=> 'Add Permission',
				115	=> 'Add Column in raids-table',
				116	=> 'Add Permission for calendar raidnotes',
				117	=> 'Alter Styles Table',
				118	=> 'Alter Styles Table',
				119	=> 'Alter Session Table',
			),
			'german' => array(
				...
				114	=> 'Füge Berechtigung für Artikel-Skript hinzu',
				115	=> 'Füge Zelle in Raids-Tabelle hinzu',
				116	=> 'Füge Berechtigung für Kalender-Raidnotizen hinzu',
				117	=> 'Erweitere Styles Tabelle',
				118	=> 'Erweitere Styles Tabelle',
				119	=> 'Erweitere Session Tabelle',
			),
		);
		...
		$this->sqls = array(
			...
			114 => "INSERT INTO `__auth_options` (`auth_value`) VALUES ('u_articles_script');",
			115 => "ALTER TABLE `__raids` ADD COLUMN `raid_additional_data` TEXT NULL DEFAULT NULL COLLATE 'utf8_bin';",
			116 => "INSERT INTO `__auth_options` (`auth_value`) VALUES ('u_calendar_raidnotes');",
			117 => "ALTER TABLE `__styles` ADD COLUMN `background_pos` VARCHAR(20) NULL DEFAULT 'normal';",
			118 => "ALTER TABLE `__styles` ADD COLUMN `background_type` TINYINT(3) UNSIGNED NOT NULL DEFAULT '0';",
			119 => "ALTER TABLE `__sessions` ADD COLUMN `session_vars` MEDIUMTEXT COLLATE 'utf8_bin' NULL;"
