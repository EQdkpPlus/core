...
class update_2305 extends sql_update_task {
	public $author			= 'GodMod';
	public $version			= '2.3.0.5.0'; //new plus-version
	public $ext_version		= '2.3.0.5'; //new plus-version
	public $name			= 'Tmp-Update 2.3.0.5 (remove before release)';
	...
	public function __construct(){
		...
		$this->langs = array(
			'english' => array(
				'update_2305'	=> 'EQdkp Plus 2.3.0.5 Update',
