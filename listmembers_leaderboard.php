...
// Language (en/de/fr)
if($eqdkp->config['default_game'] == 'WoW' && $eqdkp->config['game_language'] == 'en')
{
	define('LB_LANGUAGE', "en");
}
elseif($eqdkp->config['default_game'] == 'WoW' && $eqdkp->config['game_language'] == 'de')
{
 ...
 if ($conf_plus['pk_multidkp'] == 1)
{
	...
	{
		$member_multidkp = $dkpplus-> multiDkpAllMemberArray($multifilter) ; // create the multiDKP Array
