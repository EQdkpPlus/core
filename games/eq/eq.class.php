 ...
 * -----------------------------------------------------------------------
 * Began:       01.07.2009
 * Date:        $Date: 2009-10-29 00:46:32 +0100 (Do, 29 Okt 2009) $
 * -----------------------------------------------------------------------
 ...
 * @version     $Rev: 6306 $
 *
 * $Id: wow.class.php 6306 2009-10-28 23:46:32Z hoofy_leon $
 */
	...
	private function load_filters($langs)
	{
        ...
        foreach($langs as $lang) {
    		...
    		$this->filters[$lang] = array(
				...
				array('name' => $this->glang('plate', $lang), 'value' => array(1 => 'class', 8 => 'class', 11 => 'class', 13 => 'class')),
				array('name' => $this->glang('chain', $lang), 'value' => array(9 => 'class', 10 => 'class', 12 => 'class')),
				array('name' => $this->glang('leather', $lang), 'value' => array(2 => 'class', 3 => 'class', 6 => 'class')),
				array('name' => $this->glang('silk', $lang), 'value' => array(4 => 'class', 5 => 'class', 7 => 'class', 14 => 'class')),
			);
		}
	}
  }#class
