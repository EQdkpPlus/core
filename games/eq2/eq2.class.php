	...
	private function load_filters($langs)
	{
        ...
        foreach($langs as $lang) {
    		...
    		$this->filters[$lang] = array_merge($this->filters[$lang], array(
			    ...
			    array('name' => $this->glang('very_light', $lang), 'value' => 'class:5,6,11,15,23,24'),
			    array('name' => $this->glang('light', $lang), 'value' => 'class:4,9,13,22'),
			    array('name' => $this->glang('medium', $lang), 'value' => 'class:1,3,7,8,14,17,21'),
			    array('name' => $this->glang('heavy', $lang), 'value' => 'class:2,10,12,16,18,20'),
			));
		}
	}
