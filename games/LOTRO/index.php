...
class Manage_Game
{
  ...
  function do_it($install,$lang)
  {
    ...
    {
      $classes = array(
        array('Unknown', 'leichte Rüstung',0,75),
        array('Barde', 'mittlere Rüstung',0,75),
        array('Hauptmann', 'schwere Rüstung',0,75),
        array('Jäger', 'mittlere Rüstung',0,75),
        array('Kundiger', 'leichte Rüstung',0,75),
        array('Schurke', 'mittlere Rüstung',0,75),
        array('Wächter', 'schwere Rüstung',0,75),
        array('Waffenmeister', 'schwere Rüstung',0,75),
        array('Runenbewahrer', 'leichte Rüstung',0,75),
        array('Hüter', 'mittlere Rüstung',0,75)
      );
