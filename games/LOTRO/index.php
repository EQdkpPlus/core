...
class Manage_Game
{
  ...
  function do_it($install,$lang)
  {
    ...
    {
      $classes = array(
        array('Unknown', 'leichte Rüstung',0,65),
        array('Barde', 'mittlere Rüstung',0,65),
        array('Hauptmann', 'schwere Rüstung',0,65),
        array('Jäger', 'mittlere Rüstung',0,65),
        array('Kundiger', 'leichte Rüstung',0,65),
        array('Schurke', 'mittlere Rüstung',0,65),
        array('Wächter', 'schwere Rüstung',0,65),
        array('Waffenmeister', 'schwere Rüstung',0,65),
        array('Runenbewahrer', 'leichte Rüstung',0,65),
        array('Hüter', 'mittlere Rüstung',0,65)
      );
    ...
    {
      $classes = array(
        array('Unknown', 'Light Armour',0,65),
        array('Minstrel', 'Medium Armour',0,65),
        array('Captain', 'Heavy Armour',0,65),
        array('Hunter', 'Medium Armour',0,65),
        array('Lore-master', 'Light Armour',0,65),
        array('Burglar', 'Medium Armour',0,65),
        array('Guardian', 'Heavy Armour',0,65),
        array('Champion', 'Heavy Armour',0,65),
        array('Runekeeper', 'Light Armour',0,65),
        array('Warden', 'Medium Armour',0,65)
      );
