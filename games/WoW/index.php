  ...
  function do_it($install,$lang)
  {
    ...
    elseif($lang == 'ru')
    {
      $classes = array(
        ...
        array('Ğàçáîéíèê', 'Êîæà',0,80,2),
        array('Îõîòíèê', 'Êîëü÷óãà',0,80,4),
        array('Æğåö', 'Òêàíü',0,80,6),
        array('Äğóèä', 'Êîæà',0,80,7),
    ...
    elseif($lang == 'es')
    {
      $classes = array(
        array('Caballero de la muerte', 'Placas',0,80,20),
      	...
      	array('Paladín', 'Placas',0,80,13),
      	array('Sacerdote', 'Tela',0,80,6),
      	array('Pícaro', 'Cuero',0,80,2),
