...
class Manage_Game
{
  ...
  var $maxlevel = 80;
   ...
   function do_it($db,$table_prefix,$install,$lang,$install=true)
   {
    ...
    array_push($aq, "UPDATE ". $table_prefix ."style_config SET logo_path='wowlogo3.png' WHERE style_id = 35  ;");

    //Do this SQL Query NOT if the Eqdkp is installed -> only @ the first install
    if($install)
    {
	    #Set the Users Template
	   	array_push($aq, "UPDATE ". $table_prefix ."config SET config_value = 36 WHERE config_name='default_style' ;");
	   	array_push($aq, "UPDATE ". $table_prefix ."users SET user_style = '36' ;");
