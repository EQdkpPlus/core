...
class GameFilter
{
  function addFilter($filter)
  {
		...
		#Pool4: Tier8-10 warrior, hunter, shaman
		###############################################
		$a_filterIds = array();
	    $a_filterIds[] = '(class_id=3)';
	    $a_filterIds[] = 'or (class_id=4)';
	    ...
	    $a_filterIds[] = 'or (class_id=8)';
	    $a_filterIds[] = 'or (class_id=9)';
	     $filter_list['pool1'] = $this->assing_filter_rows($a_filterIds,'filter_row',$filter,'pool1','[Tier8-10 Pool1]');

		#Pool5: Tier8-10 rogue, mage, druid, dk
		###############################################
		$a_filterIds = array();
	    $a_filterIds[] = '(class_id=2)';
	    $a_filterIds[] = 'or (class_id=11)';
	    $a_filterIds[] = 'or (class_id=7)';
	    $a_filterIds[] = 'or (class_id=20)';
	     $filter_list['pool2'] = $this->assing_filter_rows($a_filterIds,'filter_row',$filter,'pool2','[Tier8-10 Pool2]');	     
	     
		#Pool6: Tier8-10 Paladin, priest, warlock
		###############################################
		$a_filterIds = array();
	    $a_filterIds[] = '(class_id=5)';
	    $a_filterIds[] = 'or (class_id=13)';
	    $a_filterIds[] = 'or (class_id=6)';
	    $a_filterIds[] = 'or (class_id=10)';
	    $filter_list['pool3'] = $this->assing_filter_rows($a_filterIds,'filter_row',$filter,'pool3','[Tier8-10 Pool3]');	    
