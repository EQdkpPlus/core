	...
	private function load_filters($langs)
	{
        ...
        foreach($langs as $lang) {
    		...
    		$this->filters[$lang] = array_merge($this->filters[$lang], array(
		        ...
		        array('name' => $this->glang('rogue', $lang), 'value' => 'class:1,2,11'),
		        array('name' => $this->glang('soldier', $lang), 'value' => 'class:4,5,7'),
		        array('name' => $this->glang('mage', $lang), 'value' => 'class:6,8,9'),
		        array('name' => $this->glang('priest', $lang), 'value' => 'class:3,10,12'),
			));
		}
	}
