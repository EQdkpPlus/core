...
if(!class_exists('lotro')) {
  class lotro
  {
    ...
    public  $icons = array('3dmodel', 'classes', 'classes_big', 'event', 'races');
	...
	private function load_filters($langs)
	{
        ...
        foreach($langs as $lang) {
    		...
    		$this->filters[$lang] = array_merge($this->filters[$lang], array(
		        ...
		        array('name' => $this->glang('heavy', $lang), 'value' => array(2 => 'class', 6 => 'class', 7 => 'class')),
		        array('name' => $this->glang('medium', $lang), 'value' => array(1 => 'class', 3 => 'class', 5 => 'class', 9 => 'class')),
		        array('name' => $this->glang('light', $lang), 'value' => array(4 => 'class', 9 => 'class')),
			));
		}
	}
	...
	public function get_OnChangeInfos($install=false)
	{
	    ...
	    $info['aq'] = array(
            ...
            "UPDATE __styles SET logo_path='lotro_header_01.gif' WHERE style_id=31 or style_id=32  ;" ,
	    );
