    ...
    */
    ...
    function page_header()
    {
      ...
      $tpl->assign_vars(array(
	            ...
	            'OVERLIB_JS_PATH' => $this->root_path.'itemstats/overlib/overlib.js',
        ...
        $classsql = 'SELECT class, color FROM '.CLASSCOLOR_TABLE." WHERE template='".$user->style['style_id']."'";
        ...
        {
        	$main_menu3 = $this->createLinkMenu($conf_plus['pk_links'],$this->root_path);
        ...
        if ( !$this->gen_simple_header )
        {
            $tpl->assign_vars(array(
                ...
                'MAIN_MENU1_V' => $html->createVTable($main_menu1_V,'Menu'),
                'MAIN_MENU2' => $main_menu2,
                'MAIN_MENU2_V' => $html->createVTable($main_menu2_V,'EQDKP'),
