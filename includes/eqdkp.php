...
class EQdkp
{
    ...
    */
    ...
    {
        global $db, $user, $tpl, $pm, $conf_plus, $table_prefix, $debug;
        global $SID, $eqdkpplus_vcontrol, $eqdkp;
				...
				while ( $pluslinkrow = $db->fetch_record($plinks_result) )
   				{
   					...
   					// Output Link
						if(trim($user->style['template_path']) == 'defaultV' or
						   ...
						   trim($user->style['template_path']) == 'WoWMoonclaw01V' or
	                       trim($user->style['template_path']) == 'wow3theme' or
                           trim($user->style['template_path']) == 'm9wow3eq' or
                           trim($user->style['template_path']) == 'wowV'
...
// end of Links addition
    ...
    function page_tail()
    {
        global $db, $user, $tpl, $pm, $eqdkpplus_vcontrol, $html, $debug;
        global $SID;
