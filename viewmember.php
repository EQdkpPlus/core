...
if ( (isset($_GET[URI_NAME])) && (strval($_GET[URI_NAME] != '')) )
{
	...
	$class_race = get_RenderImages($member['member_class_id'],$member['member_race_id'],$member['member_name'] );
	...
	$COMMENT = ($conf_plus['pk_disable_comments'] == 1) ? '' : $comments->Show($member['member_id'],'member') ;
