...
#                    );
    ...
    // Drops
    //
    $sql = 'SELECT i.item_id, i.item_buyer, i.item_name, i.item_value, c.class_id, c.class_name
            FROM ' . ITEMS_TABLE . " i
    		INNER JOIN (" . MEMBERS_TABLE . " m INNER JOIN " . CLASS_TABLE . " c ON m.member_class_id = c.class_id) 
